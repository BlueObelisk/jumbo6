...
/**
 * user-modifiable class supporting arg. * autogenerated from schema use as a
...
public class CMLArg extends AbstractArg {
     ...
     */
    public static List<CMLArg> getArgs(CMLElement element) {
    ...
    void substituteAttributes(Element element) {
    ...
    public static void processArgs(CMLElement element) {
        Nodes parameterNameArgs = 
            element.query("cml:arg[@parameterName]", X_CML);
...
//            arg.substituteParameter(element);
    ...
    public static void substituteParameterName(
        ...
        Nodes nameArgs = 
            element.query("cml:arg[@parameterName='"+name+"']", X_CML);
        if (nameArgs.size() == 0) {
    ...
    public static void substituteParentAttributes(CMLElement element) {
        Nodes parentAttributeArgs = 
            element.query(".//cml:arg[@parentAttribute]", X_CML);
...
//            parent.addAttribute(new Attribute(parentAttribute, attValue));
    ...
    public static void substituteTextContent(CMLElement element) {
        Nodes textContentArgs = 
            element.query(".//cml:arg[@substitute[.='.']]", X_CML);
    ...
    public void processArg(CMLElement element) {
        if (this.getParentAttribute() != null) {
            ...
            this.detach();
//            this.removeAttribute("parentAttribute");
        }
    }
     ...
     */
    public static void addArgs(CMLElement current, String localName) {
        Nodes nodes = current.query(".//cml:"+localName+"[@ref]", X_CML);
