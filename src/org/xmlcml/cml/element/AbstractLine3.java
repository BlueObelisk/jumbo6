...
// fields;
    ...
    * @param old AbstractLine3 to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("point3", "point3");
        attributeGroupNameTable.put("vector3", "vector3");
    };
    ...
    */
    public double[] getPoint3() {
        CMLAttribute _att_point3 = (CMLAttribute) getAttribute("point3");
        if (_att_point3 == null) {
            return null;
        }
        return ((DoubleArrayAttribute)_att_point3).getDoubleArray();
    }
    /** A point in 3 dimensions.
    *
    * can be used for any complex 
    ...
    * @param value point3 value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setPoint3(double[] value) throws CMLRuntimeException {
            CMLAttribute _att_point3 = null;
            try {
        		_att_point3 = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("point3"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_point3 == null) {
            ...
            super.addAttribute(_att_point3);
        ((DoubleArrayAttribute)_att_point3).setCMLValue(value);
    }
    /** A point in 3 dimensions.
    *
    * can be used for any complex 
    ...
    */
    private void setPoint3(String value) throws CMLRuntimeException {
            CMLAttribute _att_point3 = new DoubleArrayAttribute((DoubleArrayAttribute)CMLAttributeList.getAttribute("point3"));
            if (_att_point3 == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : point3; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_point3);
    ...
    */
    public double[] getVector3() {
        CMLAttribute _att_vector3 = (CMLAttribute) getAttribute("vector3");
        if (_att_vector3 == null) {
            return null;
        }
        return ((DoubleArrayAttribute)_att_vector3).getDoubleArray();
    }
    /** A vector in 3 dimensions.
    *
    * can be used for any complex geometrical object,
    ...
    */
    public void setVector3(double[] value) throws CMLRuntimeException {
            CMLAttribute _att_vector3 = null;
            try {
        		_att_vector3 = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("vector3"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_vector3 == null) {
            ...
            super.addAttribute(_att_vector3);
        ((DoubleArrayAttribute)_att_vector3).setCMLValue(value);
    }
    /** A vector in 3 dimensions.
    *
    * can be used for any complex geometrical object,
    ...
    */
    private void setVector3(String value) throws CMLRuntimeException {
            CMLAttribute _att_vector3 = new DoubleArrayAttribute((DoubleArrayAttribute)CMLAttributeList.getAttribute("vector3"));
            if (_att_vector3 == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : vector3; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_vector3);
    ...
    */
    public void setXMLContent(double[] value) throws CMLRuntimeException {
        if (_xmlContent == null) {
            ...
            _xmlContent.setSchemaType(CMLTypeList.getType("line3Type"));
        }
