...
*/
public abstract class AbstractCopy extends CMLElement {
...
// fields;
    ...
    /** local name*/
    public final static String TAG = "copy";
    /** default constructor.
    *
    ...
    * @param old AbstractCopy to copy

    */

    public AbstractCopy(AbstractCopy old) {
