...
public class CMLSpectrum extends AbstractSpectrum {
     ...
     * @return CMLSpectrum
     */
    public static CMLSpectrum makeElementInContext(Element parent) {
        ...
        if (parent != null) {
            for (int i = 0; i < parent.getChildCount(); i++) {
                ...
                if (node instanceof CMLMolecule) {
                    if (molecule != null) {
                        throw new CMLRuntimeException("duplicate sibling molecules");
                    }
    ...
    /**
     * returns sibling molecule of ancestor spectrum.
     * 
     * @param element
     *            to find aunt of.
