...
public class CMLVector3 extends AbstractVector3 {
     ...
     * @return CMLVector3
     */
    public static CMLVector3 makeElementInContext(Element parent) {
    ...
    public void finishMakingElement(Element parent) throws CMLRuntimeException {
        ...
        if (array == null) {
            throw new CMLRuntimeException("vector must not be empty");
        } else if (array.length != 3) {
            throw new CMLRuntimeException("vector must have 3 double components");
        }
    }
     ...
     * @param xyz3
     *            3 components
     * @throws org.xmlcml.cml.base.CMLRuntimeException
     *             xyz3 must be of length 3
     */
    public void setXYZ3(double[] xyz3) throws CMLRuntimeException {
        if (xyz3.length != 3) {
            throw new CMLRuntimeException("xyz3 must be of length 3; found: "
                    + xyz3.length);
        }
