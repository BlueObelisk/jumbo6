...
public class CMLArrayList extends org.xmlcml.cml.element.AbstractArrayList {
    ...
    * @return CMLArrayList
    */
    public static CMLArrayList makeElementInContext(Element parent) {
        return new CMLArrayList();
    }

    /** create tableHeader from chidren.
     * @throws CMLRuntimeException if chidren are inconsistent
...
//        CMLUtil.throwNYI();
     ...
     * @throws CMLRuntimeException if inconsistent
