...
public class CMLCrystal extends AbstractCrystal {
     ...
     */
    public CMLCrystal(double[] params) throws CMLRuntimeException {
    ...
    public CMLCrystal(CMLScalar[] scalars) {
        ...
        if (scalars == null || scalars.length != 6) {
            throw new CMLRuntimeException("scalar must be of length 6");
        }
    ...
    public RealSquareMatrix getOrthogonalizationMatrix() throws CMLException {
    ...
    public void setCellParameters(double a, double b, double c, double alpha,
            double beta, double gamma) throws CMLException {
     ...
     *             corrupted number of cell parameters
     */
    public void setCellParameters(double params[]) throws CMLException {
    ...
    public void setCellParameters(double params[], double error[])
        ...
        if (params == null || params.length != 6) {
            throw new CMLException("Must have 6 cell parameters");
        }
    ...
    public List<CMLCellParameter> createCellParameterElements()
        ...
        if (cellParameterElements != null && cellParameterElements.size() == 2) {
            ...
            throw new CMLRuntimeException("no cell params");
        }
     ...
     */
    public double[] getCellParameterValues() throws CMLException {
    ...
    public CMLLattice getLattice() {
        ...
        try {
            matrix = this.getOrthogonalizationMatrix();
        } catch (CMLException e) {
            throw new CMLRuntimeException("Cannot get orthogonalization matrix " + e);
        }
    ...
    public double getCellVolume() {
        double[] param = null;
        try {
            param = this.getCellParameterValues();
        } catch (CMLException e) {
            throw new CMLRuntimeException("bug: " + e);
        }
        double dtor = Math.PI / 180.0;
    ...
    public double getCellVolume2() {
        ...
        try {
            orthMat = this.getOrthogonalizationMatrix();
        } catch (CMLException e) {
            throw new CMLRuntimeException("bug: " + e);
        }
    ...
    private static CMLScalar[] createScalars(double[] params, double[] error)
            throws CMLRuntimeException {
        if (params == null || params.length != 6) {
            throw new CMLRuntimeException("params must be of length 6");
        }
    ...
    public CMLLattice getPrimitiveLattice(CMLCrystal.Centering centering) {
        ...
        if (centering.equals(Centering.P)
            ...
            throw new CMLRuntimeException("R not implemented");
        }
    ...
    public static CMLCrystal getContainedCrystal(CMLElement element) throws CMLRuntimeException {
        ...
        if (crystalNodes.size() == 0) {
            ...
            throw new CMLRuntimeException("TOO MANY <crystal> FOUND "+crystalNodes.size());
        }
