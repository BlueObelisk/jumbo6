...
// fields;
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("fileId", "fileId");
    ...
    */
    public String getFileId() {
        CMLAttribute _att_fileId = (CMLAttribute) getAttribute("fileId");
        if (_att_fileId == null) {
            return null;
        }
        return ((StringAttribute)_att_fileId).getString();
    }
    /** Information identifying the name of a file or other resource.
    *
    * This allows an element (such as cml) to carry limited
    ...
    * @param value fileId value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setFileId(String value) throws CMLRuntimeException {
            CMLAttribute _att_fileId = null;
            try {
        		_att_fileId = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("fileId"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_fileId == null) {
            ...
            super.addAttribute(_att_fileId);
        ((StringAttribute)_att_fileId).setCMLValue(value);
    }
