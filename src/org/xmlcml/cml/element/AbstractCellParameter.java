...
// fields;
    ...
    * @param old AbstractCellParameter to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("type", "cellParameterType");
        attributeGroupNameTable.put("error", "cellParameterError");
    };
    ...
    */
    public void setType(String value) throws CMLRuntimeException {
            ...
            try {
        		_att_type = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("cellParameterType"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_type == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : cellParameterType; probably incompatible attributeGroupName and attributeName");
            }
    ...
    */
    public double[] getError() {
        CMLAttribute _att_error = (CMLAttribute) getAttribute("error");
        if (_att_error == null) {
            return null;
        }
        return ((DoubleArrayAttribute)_att_error).getDoubleArray();
    }
    /** Error array for cellParameter.
    *
    * 3 numbers giving error limits on paremters.
    ...
    */
    public void setError(double[] value) throws CMLRuntimeException {
            CMLAttribute _att_error = null;
            try {
        		_att_error = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("cellParameterError"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_error == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : cellParameterError; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_error);
        ((DoubleArrayAttribute)_att_error).setCMLValue(value);
    }
    /** Error array for cellParameter.
    *
    * 3 numbers giving error limits on paremters.
    ...
    */
    private void setError(String value) throws CMLRuntimeException {
            CMLAttribute _att_error = new DoubleArrayAttribute((DoubleArrayAttribute)CMLAttributeList.getAttribute("cellParameterError"));
            if (_att_error == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : cellParameterError; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_error);
