...
public class CMLMap extends org.xmlcml.cml.element.AbstractMap {
    ...
    void checkAndCreateTablesAndAddLinks() {
        if (fromToTable == null || toFromTable == null || toLinkTable == null
                || fromLinkTable == null) {
            makeTables();
            addLinks();
        }
     ...
     *            to add
     */
    protected void addLink(CMLLink link) {
        if (link != null) {
            addLinkToTable(link);
            super.addLink(link);
        }
    ...
    public void addUniqueLink(CMLLink link, Direction control) {
        ...
        if (control.equals(Direction.BOTH)) {
            ...
            throw new CMLRuntimeException("FROM not implemented");
            // CMLLink oldLink = getFromToLink(fromLinkS, toLinkS);
            // if (oldLink != null) {
            // removeLink(oldLink);
            // }
            ...
            throw new CMLRuntimeException("TO not implemented");
            // CMLLink oldLink = getFromToLink(fromLinkS, toLinkS);
            // if (oldLink != null) {
            // removeLink(oldLink);
            // }
