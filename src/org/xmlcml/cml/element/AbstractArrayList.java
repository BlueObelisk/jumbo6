...
// fields;
    ...
    * @param old AbstractArrayList to copy
    ...
    */
    ...
    static {
        attributeGroupNameTable.put("shape", "shape");
    ...
    */
    public String getShape() {
        CMLAttribute _att_shape = (CMLAttribute) getAttribute("shape");
        if (_att_shape == null) {
            return null;
        }
        return ((StringAttribute)_att_shape).getString();
    }
    /** shape of object.
    *
    * Mainly square, but extensible through the _xsd:union_ mechanism.
    ...
    */
    public void setShape(String value) throws CMLRuntimeException {
            CMLAttribute _att_shape = null;
            try {
        		_att_shape = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("shape"));
            ...
            super.addAttribute(_att_shape);
        ((StringAttribute)_att_shape).setCMLValue(value);
    }
