...
*/
public abstract class AbstractFor extends CMLElement {
...
// fields;
    ...
    /** local name*/
    public final static String TAG = "for";
    /** default constructor.
    *
    ...
    * @param old AbstractFor to copy

    */

    public AbstractFor(AbstractFor old) {
    ...
    static {
        ...
        attributeGroupNameTable.put("step", "step");
        attributeGroupNameTable.put("list", "list");
    };
    ...
    * @return CMLAttribute
    */
    public CMLAttribute getStepAttribute() {
        return (CMLAttribute) getAttribute("step");
    }
    /** The step value.
    *
    * The step value in any allowable 
    ...
    */
    public String getStep() {
        CMLAttribute _att_step = (CMLAttribute) getAttribute("step");
        if (_att_step == null) {
            return null;
        }
        return ((StringAttribute)_att_step).getString();
    }
    /** The step value.
    *
    * The step value in any allowable 
    ...
    */
    public void setStep(String value) throws CMLRuntimeException {
            CMLAttribute _att_step = null;
            try {
        		_att_step = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("step"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_step == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : step; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_step);
        ((StringAttribute)_att_step).setCMLValue(value);
    }
    /** A list of values.
    *
    ...
    * @return CMLAttribute
    */
    public CMLAttribute getListAttribute() {
        return (CMLAttribute) getAttribute("list");
    }
    /** A list of values.
    *
    * Normally for iterations.
    ...
    */
    public String getList() {
        CMLAttribute _att_list = (CMLAttribute) getAttribute("list");
        if (_att_list == null) {
            return null;
        }
        return ((StringAttribute)_att_list).getString();
    }
    /** A list of values.
    *
    * Normally for iterations.
    ...
    */
    public void setList(String value) throws CMLRuntimeException {
            CMLAttribute _att_list = null;
            try {
        		_att_list = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("list"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_list == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : list; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_list);
        ((StringAttribute)_att_list).setCMLValue(value);
    }
