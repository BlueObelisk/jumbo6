 ...
 * 
 */
public class CMLUnitTypeList extends AbstractUnitTypeList implements
        GenericDictionary {
     ...
     */
    public static CMLUnitTypeList makeElementInContext(Element parent) {
     ...
     * @throws CMLException if file is not a well-formed unitTypeList
     */
    public static CMLUnitTypeList createUnitTypeList(URL url)
            throws IOException, CMLException {
