/* validator for Xerces adapted to provide test
 *
 */
/*
 ...
 * tree in order to get information about the document. The output of this
 * program shows the time and count of elements, attributes, ignorable
 * whitespaces, and characters appearing in the document. Three times are shown:
 * the parse time, the first traversal of the document, and the second traversal
 * of the tree.
 * <p>
 * This class is useful as a "poor-man's" performance tester to compare the
 * speed and accuracy of various DOM parsers. However, it is important to note
...
public class XercesValidator {
    ...
    static XercesValidator xercesValidator;
    ...
    protected static final String DEFAULT_PARSER_NAME = "org.xmlcml.cml.element.test.XercesWrapper";
     ...
     * @param uri
     */
    public void printResults(PrintWriter out, String uri, long parse,
    ...
    // MAIN
    //
    private static XercesValidator getXercesValidator() {
        if (xercesValidator == null) {
            xercesValidator = new XercesValidator();
        }
        return xercesValidator;
    }
    ...
    public static void main(String argv[]) {
        ...
        // variables
        XercesValidator counter = getXercesValidator();
        ...
        for (int i = 0; i < argv.length; i++) {
            ...
            try {
                ...
                ParserWrapper.DocumentInfo documentInfo = parser
                        .getDocumentInfo();
                ...
                throw new CMLRuntimeException("Parse exception: " + e);
                // ignore
            } catch (Exception e) {
