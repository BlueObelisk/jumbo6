...
public class CMLPlane3 extends AbstractPlane3 {
     ...
     * @return CMLPlane3
     */
    public static CMLPlane3 makeElementInContext(Element parent) {
    ...
    public void finishMakingElement(Element parent) throws CMLRuntimeException {
        ...
        if (array == null) {
            throw new CMLRuntimeException("plane must not be empty");
        } else if (array.length != 4) {
            throw new CMLRuntimeException("plane must have 4 double components");
        }
    }
     ...
     * @throws CMLException
     */
    public CMLPlane3(double[] lmn, double d) throws CMLException {
        this();
        try {
            Util.check(lmn, 3);
     ...
     * @throws CMLRuntimeException
     */
    public CMLPlane3(CMLVector3 v, double d) throws CMLRuntimeException {
        Plane3 pp;
        try {
     ...
     */
    public Plane3 getEuclidPlane3() throws CMLRuntimeException {
        Plane3 pleucl3 = null;
        try {
