...
// fields;
    ...
    * @param old AbstractMetadata to copy
    ...
    */
    ...
    static {
        attributeGroupNameTable.put("content", "content");
        ...
        attributeGroupNameTable.put("name", "metadataType");
    ...
    */
    public String getContent() {
        CMLAttribute _att_content = (CMLAttribute) getAttribute("content");
        if (_att_content == null) {
            return null;
        }
        return ((StringAttribute)_att_content).getString();
    }
    /** content of metadata.
    *
    ...
    */
    public void setContent(String value) throws CMLRuntimeException {
            CMLAttribute _att_content = null;
            try {
        		_att_content = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("content"));
            ...
            super.addAttribute(_att_content);
        ((StringAttribute)_att_content).setCMLValue(value);
    }
    ...
    */
    public void setName(String value) throws CMLRuntimeException {
            ...
            try {
        		_att_name = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("metadataType"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_name == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : metadataType; probably incompatible attributeGroupName and attributeName");
            }
