...
// fields;
    ...
    * @param old AbstractTable to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("tableType", "tableType");
    ...
    */
    public String getTableType() {
        CMLAttribute _att_tableType = (CMLAttribute) getAttribute("tableType");
        if (_att_tableType == null) {
            return null;
        }
        return ((StringAttribute)_att_tableType).getString();
    }
    /** type of table.
    *
    * controls content
    ...
    * @param value tableType value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setTableType(String value) throws CMLRuntimeException {
            CMLAttribute _att_tableType = null;
            try {
        		_att_tableType = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("tableType"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_tableType == null) {
            ...
            super.addAttribute(_att_tableType);
        ((StringAttribute)_att_tableType).setCMLValue(value);
    }
    ...
    */
    ...
    /** add table element.
    *
    * @param tableHeader tableHeader child to add
    ...
    */
    ...
    /** add table element.
    *
    * @param tableContent tableContent child to add
    ...
    */
    ...
    /** add table element.
    *
    * @param tableRowList tableRowList child to add
    ...
    */
    ...
    /** add table element.
    *
    * @param arrayList arrayList child to add
