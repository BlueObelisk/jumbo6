...
//            CMLMolecule molecule = this.getMolecule();
    ...
    public static boolean areWithinBondingDistance(final CMLAtom atom1,
            final CMLAtom atom2, final double radius1, final double radius2,
            double tolerance) {
        // there may be special elements which are asymmetric and need treatment
//        String e1 = atom1.getElementType();
//        String e2 = atom2.getElementType();
        ...
        double radsumDelta = radsum * 0.15;  // fudge for larger elements
        tolerance = Math.max(radsumDelta, tolerance);
        double covd = radsum + tolerance;
        double covd2 = covd * covd;
        return (d2 < covd2);
    }

    /**
     * are atoms within bonding distance.
     * 
     * @param atom1
     * @param atom2
     * @return true if within sum of radii
     */
    public static boolean areWithinBondingDistance(final CMLAtom atom1,
            final CMLAtom atom2) {
        final String type1 = atom1.getElementType();
        final String type2 = atom2.getElementType();
        return areWithinBondingDistance(atom1, atom2, ChemicalElement
                .getChemicalElement(type1).getCovalentRadius(), ChemicalElement
                .getChemicalElement(type2).getCovalentRadius(), ChemicalElement
