...
public class CMLMetadata extends AbstractMetadata {
     ...
     * @return CMLMetadata
     */
    public static CMLMetadata makeElementInContext(Element parent) {
     ...
     */
    public void setMetadataType(String value) throws CMLRuntimeException {
    }
    ...
    /*--
     ...
     _att_metadataType = new StringAttribute((StringAttribute)CMLAttributeList.getAttribute("metadataType"));
     super.addAttribute(_att_metadataType);
     }
     ((StringAttribute)_att_metadataType).setCMLValue(value);
     }
     --*/
    ...
    /*--
     ...
     return ((StringAttribute)_att_metadataType).getString();
