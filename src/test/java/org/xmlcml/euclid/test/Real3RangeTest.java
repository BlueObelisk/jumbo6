...
public class Real3RangeTest extends EuclidTestBase {
    ...
    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.Real3Range()'
     */
    @Test
    ...
    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.Real3Range(RealRange,
     * RealRange, RealRange)'
     */
    @Test
    ...
    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.Real3Range(Real3Range)'
     */
    @Test
    ...
    public static void assertEquals(
            String msg, Real3Range r3ref, Real3Range r3, double epsilon) {
        RealRangeTest.assertEquals("xRange", r3.getXRange(), r3ref.getXRange(), epsilon);
        RealRangeTest.assertEquals("yRange", r3.getYRange(), r3ref.getYRange(), epsilon);
        RealRangeTest.assertEquals("zRange", r3.getZRange(), r3ref.getZRange(), epsilon);
    }

    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.isEqualTo(Real3Range)'
     */
    @Test
    ...
    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.plus(Real3Range)'
     */
    @Test
    ...
    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.getXRange()'
     */
    @Test
    ...
    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.add(Axis3, double)'
     */
    @Test
    ...
    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.includes(Point3)'
     */
    @Test
    ...
    /**
     * Test method for 'org.xmlcml.euclid.Real3Range.add(Point3)'
     */
    @Test
    ...
    public void testGetMaxPoint3() {
        ...
        Point3Test.assertEquals("max point",
                new Point3(2., 4., 6.), maxp, EPS);
    }
    ...
    public void testGetMinPoint3() {
        ...
        Point3Test.assertEquals("min point",
                new Point3(1., 3., 5.), minp, EPS);
    }
    ...
    public void testTransformEquals() {
        ...
        Assert.assertEquals("transformed x range max",
                4., r1.getXRange().getMax(), EPS);
        Assert.assertEquals("transformed y range min",
                -6., r1.getYRange().getMin(), EPS);
        Assert.assertEquals("transformed y range max",
                -5., r1.getYRange().getMax(), EPS);
        Assert.assertEquals("transformed z range min",
                -2., r1.getZRange().getMin(), EPS);
        Assert.assertEquals("transformed z range max",
                -1., r1.getZRange().getMax(), EPS);
    }
