...
public class RealSquareMatrixTest extends MatrixTest {
    ...
    public void testIsOrthogonal() {
        ...
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 0, 1, 0, -1, 0, 0, 0, 0,
                    1, });
    ...
    public void testRealSquareMatrixIntDoubleArray() {
        RealMatrix rm = new RealMatrix(3, 3, new double[] { 1.0, 2.0, 3.0, 2.0, 4.0,
                    6.0, 3.0, 6.0, 9.0, });
        RealSquareMatrix rsm = new RealSquareMatrix(3, new double[] { 1.0, 2.0, 3.0, 2.0,
                    4.0, 6.0, 3.0, 6.0, 9.0, });
    ...
    public void testRealSquareMatrixRealMatrixIntIntInt() {
        RealMatrix rm = new RealMatrix(3, 4, new double[] { 11., 12., 13., 14., 21.,
                    22., 23., 24., 31., 32., 33., 34. });
        RealSquareMatrix rsm = new RealSquareMatrix(rm, 1, 1, 2);
        RealMatrix rm1 = new RealMatrix(2, 2, new double[] { 22., 23., 32., 33., });
    ...
    public void testRealSquareMatrixRealMatrix() {
        RealMatrix rm = new RealMatrix(2, 2, new double[] { 22., 23., 32., 33., });
    ...
    public void testRealSquareMatrixDoubleArrayArray() {
        ...
        RealMatrix rm = new RealMatrix(3, 3, new double[] { 11., 12., 13., 21., 22.,
                    23., 31., 32., 33., });
        MatrixTest.assertEquals("real matrix", rm, rsm, EPS);
    }
    ...
    public void testPlusRealSquareMatrix() {
        ...
        RealMatrix rm = new RealMatrix(3, 3, new double[] { 22., 24., 26., 42., 44.,
                    46., 62., 64., 66., });
        MatrixTest.assertEquals("real matrix", rm, rsm, EPS);
    }
    ...
    public void testMultiplyRealSquareMatrix() {
        ...
        RealMatrix rm = new RealMatrix(3, 3, new double[] { 776.0, 812.0, 848.0,
    ...
    public void testDeterminant() {
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 1., 1., 1., 2., 3., 4.,
                    3., 4., 7. });
    ...
    public void testIsUnit() {
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 1., 0., 0., 0., 1., 0.,
                    0., 0., 1. });
    ...
    public void testIsSymmetric() {
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 1., 0., 3., 0., 1., 0.,
                    3., 0., 1. });
    ...
    public void testOrthonormalize() {
        ...
        RealSquareMatrix mm = new RealSquareMatrix(3, new double[] { 0.5773502691896258,
    ...
    public void testIsUpperTriangular() {
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 0., 2., 3., 0., 0., 2.,
                    0., 0., 0. });
    ...
    public void testIsLowerTriangular() {
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 0., 0., 0., 2., 0., 0.,
                    3., 2., 0. });
    ...
    public void testCopyUpperToLower() {
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 6., 7., 8., 2., 5., 4.,
                    3., 2., 9. });
        m.copyUpperToLower();
        RealSquareMatrix mm = new RealSquareMatrix(3, new double[] { 6., 7., 8., 7., 5., 4.,
                    8., 4., 9. });
    ...
    public void testCopyLowerToUpper() {
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 6., 7., 8., 2., 5., 4.,
                    3., 2., 9. });
        m.copyLowerToUpper();
        RealSquareMatrix mm = new RealSquareMatrix(3, new double[] { 6., 2., 3., 2., 5., 2.,
                    3., 2., 9. });
        MatrixTest.assertEquals("copy upper", mm, m, EPS);
    }
    ...
    public void testTranspose() {
        RealSquareMatrix m = new RealSquareMatrix(3, new double[] { 6., 7., 8., 2., 5., 4.,
                    3., 1., 9. });
        m.transpose();
        RealSquareMatrix mm = new RealSquareMatrix(3, new double[] { 6., 2., 3., 7., 5., 1.,
                    8., 4., 9. });
    ...
    public void testGetCrystallographicOrthogonalisation() {
        ...
        RealSquareMatrix mm = new RealSquareMatrix(3, new double[] { 9.843316493307713, 0.0,
    ...
    public void testGetInverse() {
        ...
        RealSquareMatrix mm = new RealSquareMatrix(3, new double[] { 0.3055555555555556,
