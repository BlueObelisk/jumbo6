...
public class StereochemistryToolTest {
	...
	public final void testAddWedgeHatchBonds() {
		...
		StereochemistryTool stereochemistryTool = new StereochemistryTool(
				molecule1);
...
//		alanineMAtAt.debug("ALA@@");
	...
	public final void testIsChiralCentre() {
		CMLMolecule molecule1 = makeMolecule1();
		// StereochemistryTool stereochemistryTool1 = new
		// StereochemistryTool(molecule1);
		CMLAtom atom = molecule1.getAtomById("a1");
		Assert.assertFalse("atom1 O is not chiral", StereochemistryTool
				.isChiralCentre(atom));
		atom = molecule1.getAtomById("a9");
		Assert.assertTrue("atom9 C is chiral", StereochemistryTool
				.isChiralCentre(atom));
		atom = molecule1.getAtomById("a5");
		Assert.assertFalse("atom5 C(Me)(Me) is not chiral", StereochemistryTool
				.isChiralCentre(atom));
	}
	...
	public final void testGetChiralAtoms() {
		CMLMolecule molecule1 = makeMolecule1();
		StereochemistryTool stereochemistryTool1 = new StereochemistryTool(
				molecule1);
		...
		CMLAtomSet refSet = new CMLAtomSet(molecule1, new String[] { "a9",
				"a10", "a19", "a21", "a28" });
	...
	public final void testCreate3DBondStereo() {
		...
		@SuppressWarnings("unused")
		CMLBondStereo bondStereo = st
				.create3DBondStereo(bond, ligand0, ligand1);
	}
	...
	public final void testAdd3DStereo() {
		...
		String molS = ""
				...
				+ "<atomParity atomRefs4='a28 a6 a10 a49'>11.158571879456787</atomParity>"
				+ "</atom>"
				...
				+ "<atomParity atomRefs4='a9 a21 a12 a11'>-7.957964065552211</atomParity>"
				+ "</atom>"
				...
				+ "<atomParity atomRefs4='a21 a18 a30 a20'>7.852690657645688</atomParity>"
				+ "</atom>"
