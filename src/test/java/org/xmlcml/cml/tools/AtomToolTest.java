...
public class AtomToolTest {
	...
	public final void testGetCoordinationSphereList() {
		...
		CMLAtomSet refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='1' xmlns='http://www.xml-cml.org/schema'>a1</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 0", refAtomSet, atomSet);
		atomSet = atomTool1.getCoordinationSphereSet(1);
		refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='2' xmlns='http://www.xml-cml.org/schema'>a1 a2</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 1", refAtomSet, atomSet);
		atomSet = atomTool1.getCoordinationSphereSet(2);
		refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='4' xmlns='http://www.xml-cml.org/schema'>a1 a2 a3 a4</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 2", refAtomSet, atomSet);
		atomSet = atomTool1.getCoordinationSphereSet(3);
		refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='5' xmlns='http://www.xml-cml.org/schema'>a1 a2 a3 a4 a5</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 3", refAtomSet, atomSet);
		atomSet = atomTool1.getCoordinationSphereSet(1);
		refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='2' xmlns='http://www.xml-cml.org/schema'>a1 a2</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 1", refAtomSet, atomSet);
		atomSet = atomTool1.getCoordinationSphereSet(4);
		refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='6' xmlns='http://www.xml-cml.org/schema'>a1 a2 a3 a4 a5 a6</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 4", refAtomSet, atomSet);
		atomSet = atomTool1.getCoordinationSphereSet(5);
		refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='8' xmlns='http://www.xml-cml.org/schema'>a1 a2 a3 a4 a5 a6 a7 a8</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 5", refAtomSet, atomSet);
		atomSet = atomTool1.getCoordinationSphereSet(6);
		refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='8' xmlns='http://www.xml-cml.org/schema'>a1 a2 a3 a4 a5 a6 a7 a8</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 6", refAtomSet, atomSet);
		...
		refAtomSet = (CMLAtomSet) CMLXOMTestUtils.parseValidString("<atomSet size='7' xmlns='http://www.xml-cml.org/schema'>a5 a3 a6 a2 a4 a7 a8</atomSet>");
		CMLXOMTestUtils.assertEqualsCanonically("atomSet 2", refAtomSet, atomSet);
	...
	public final void testTransformCMLTransform3() {
		...
		CMLXOMTestUtils.assertEquals("getPoint3", new double[] { 1.1, 1.2, 1.3 }, p, CC.EPS);
		AtomTool.getOrCreateTool(fixture.xomAtom[0]).transformCartesians(t);
		p = fixture.xomAtom[0].getPoint3(CoordinateType.CARTESIAN);
		CMLXOMTestUtils.assertEquals("getPoint3", new double[] { 1.2, -1.1, 2.5 }, p, CC.EPS);
	}
	...
	public final void testTransformFractionalCoordinatesCMLTransform3() {
		...
		CMLXOMTestUtils.assertEquals("getPoint3", new double[] { 0.1, 0.2, 0.3 }, p, CC.EPS);
		AtomTool.getOrCreateTool(fixture.xomAtom[0]).transformFractionals(t);
		p = fixture.xomAtom[0].getPoint3(CoordinateType.FRACTIONAL);
		CMLXOMTestUtils.assertEquals("getPoint3", new double[] { 0.2, 0.4, 0.5 }, p, CC.EPS);
	}
    ...
    public final void testGetReferencedAtoms() {
        Element cml = CMLXOMTestUtils.parseValidFile("org/xmlcml/cml/tools/rgroup1.xml");
    ...
    public void testGet3DCrossProduct() {
        ...
        CMLXOMTestUtils.assertEquals("cross3d", new double[] { 0., 2., -2. },
                cross3d, CC.EPS);
    }
    ...
    public void testGet2DCrossProduct() {
        ...
        CMLXOMTestUtils.assertEquals("cross2d", new double[] { 0., 0., -2. },
                cross2d, CC.EPS);
    }
    ...
    public void testCreateGraphicsElement1() {
        ...
        Element ref = CMLXOMTestUtils.parseValidFile("org/xmlcml/cml/tools/atom1.svg");
    ...
    public void testCreateGraphicsElement2() {
    	...
    	SVGSVG svgsvg = createSvgSvg(atomTool);
        Element ref = CMLXOMTestUtils.parseValidFile("org/xmlcml/cml/tools/atom2.svg");
        CMLXOMTestUtils.assertEqualsIncludingFloat("svg", ref, svgsvg, true, 0.0000000001);
    }
