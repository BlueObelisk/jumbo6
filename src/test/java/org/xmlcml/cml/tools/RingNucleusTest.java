...
public class RingNucleusTest  {
	...
	void makeMol() {
    	molecule = (CMLMolecule) TestUtils.parseValidFile(MOLECULE+U_S+"bg2066.xml");
	...
	void makeMol1() {
    	molecule = (CMLMolecule) TestUtils.parseValidFile(MOLECULE+U_S+"bv2018.xml");
    	ConnectionTableTool connectionTableTool = new ConnectionTableTool(molecule);
    	ringNucleusSet = connectionTableTool.getRingNucleusSet();
	}
	...
	public final void testGetRings() {
		...
		String[][] expected = new String[][] {
			...
			{"a20_a21", "a21_a23", "a23_a24", "a24_a26", "a26_a28", "a20_a28"},
			{"a12_a14", "a14_a17", "a17_a20", "a20_a21", "a21_a23", "a23_a24", "a24_a26", "a26_a28", "a28_a29", "a12_a29"},
			{"a12_a10", "a12_a14", "a14_a17", "a17_a20", "a20_a21", "a21_a23", "a23_a24", "a24_a26", "a26_a28", "a28_a29", "a29_a30", "a30_a31", "a34_a31", "a34_a10"},
		};
		...
		expected = new String[][]{
			new String[] {"a40_a41", "a41_a43", "a43_a45", "a45_a47", "a47_a49", "a40_a49"}
		};
		for (int i = 0; i < ringList.size(); i++) {
			Ring ring = ringList.get(i);
			RingTest.assertEqualCyclicBondList("ring ", expected[i], ring);
		...
		expected = new String[][] {
			new String[] {"a57_a59", "a57_a65", "a51_a65", "a51_a62", "a59_a62"},
			new String[] {"a52_a51", "a52_a54", "a57_a54", "a57_a59", "a59_a62", "a51_a62"},
		};
	...
	/**
	 * Test method for {@link org.xmlcml.cml.tools.RingNucleus#getSetOfSmallestRings(boolean)}.
	 */
	@Test
	@Ignore // depends on randome ordering
	public final void testGetSetOfSmallestRings() {
		...
		String[][] expected = new String[][] {
			...
			new String[]{"a12_a10", "a34_a10", "a34_a31", "a30_a31", "a29_a30", "a12_a29"},
			new String[]{"a12_a14", "a14_a17", "a17_a20", "a20_a28", "a28_a29", "a12_a29"},
			new String[]{"a20_a21", "a21_a23", "a23_a24", "a24_a26", "a26_a28", "a20_a28"},
		};
		for (int i = 0; i < ringList.size(); i++) {
			Ring ring = ringList.get(i);
			RingTest.assertEqualCyclicBondList("ring ", expected[i], ring);
		...
		ringList = nucleus2.getRings();
		expected = new String[][] {
			new String[]{"a52_a51", "a52_a54", "a57_a54", "a57_a65", "a51_a65"},
...
//		@SuppressWarnings("unused")
    ...
    public final void testGetRingNucleusSet() {
    	CMLMolecule molecule = (CMLMolecule) TestUtils.parseValidFile(ConnectionTableToolTest.MOLECULES+U_S+"bg2066.xml");
    	ConnectionTableTool connectionTableTool = new ConnectionTableTool(molecule);
    	...
    	String[][] expectedAtomIDs = new String[][] {
			...
			new String[]{"a2", "a8", "a23", "a21", "a34", "a17", "a20", "a10", "a26", "a24", "a30", "a12", "a31", "a29", "a28", "a14", "a9"},
    	};
    	Iterator<RingNucleus> iterator = ringNucleusSet.iterator();
    	for (int i = 0; i < 3; i++) {
