...
public class CMLPeakStructureTest extends PeakSpectrumTest {
	...
	public void testGetCouplingsFrom() throws Exception {
		// peak1
		CMLElements<CMLPeakStructure> peakStructures1 = getPeakStructures(0);
		List<CMLAtom> couplingsFrom1 = peakStructures1.get(0)
				.getCouplingsFrom();
		Assert.assertEquals("couplings from p1", "a2", couplingsFrom1.get(0)
				.getId());
		// peak 2
		CMLElements<CMLPeakStructure> peakStructures2 = getPeakStructures(1);
		...
		Assert.assertEquals("coupling 2 from p2", "a4", couplingsFrom22.get(1)
				.getId());
		// peak3
		CMLElements<CMLPeakStructure> peakStructures3 = getPeakStructures(2);
		List<CMLAtom> couplingsFrom3 = peakStructures3.get(0)
				.getCouplingsFrom();
