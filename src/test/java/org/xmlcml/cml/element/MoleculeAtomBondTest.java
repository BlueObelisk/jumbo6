...
public abstract class MoleculeAtomBondTest extends AbstractTest {
    ...
    protected void makeMol2() {
            mol2 = (CMLMolecule)  parseValidString(
            "  <molecule id='m2' "
                    + CML_XMLNS
                    + ">"
                    + "    <atomArray>"
    ...
    protected void makeMol3() {
            mol3 = (CMLMolecule)  parseValidString(
            "  <molecule id='m3' "
                    + CML_XMLNS
                    + ">"
                    + "    <atomArray>"
    ...
    protected void makeMol4() {
        mol4 = (CMLMolecule)  parseValidString(
            "  <molecule id='m4' "
                + CML_XMLNS
                + ">"
                + "    <atomArray>"
    ...
    protected void makeMol5() {
            mol5 = (CMLMolecule) parseValidString(
            "  <molecule id='m5' "
                    + CML_XMLNS
                    + ">"
                    + "    <atomArray>"
    ...
    protected void makeMol5a() {
            mol5a = (CMLMolecule) parseValidString(
                "  <molecule id='m5' "
                + CML_XMLNS
                + ">"
                + "    <atomArray>"
    ...
    protected void makeMol6() {
        mol6 = (CMLMolecule)  parseValidString(
        "  <molecule id='m6' "
            + CML_XMLNS
            + ">"
            + "    <atomArray>"
    ...
    protected void makeMol7() {
        mol7 = (CMLMolecule)  parseValidString(
        "  <molecule id='m7' "
                + CML_XMLNS
                + ">"
                + "    <atomArray>"
    ...
    protected void makeMol8() {
            mol8 = (CMLMolecule) parseValidString(
            "<molecule id='m8' "
                + CML_XMLNS
                + ">"
                + "  <molecule id='m8a'>"
    ...
    protected void makeMol9() {
            mol9 = (CMLMolecule) parseValidString(
                "<molecule id='m9' "
                    + CML_XMLNS
                    + ">"
                    + "  <atomArray>"
    ...
    protected void makeMol10() {
            mol10 = (CMLMolecule) parseValidString(
            "<molecule "+CML_XMLNS+">" +
            "  <atomArray>" +
