...
public class CMLMatrixTest extends NumericTest {
    ...
    String unitsS = "<c:cml " + "id='a234234' " + "xmlns:c='" + CML_NS + "' "
            ...
            + "xmlns:units='"+UNIT_NS+"' " + ">"
            + "<c:matrix id='s1' dictRef='cmlDict:angle' units='" + U_DEGREE
            + "' " + "  dataType='xsd:double' rows='2' columns='2'>"
    ...
    /**
     * Test method for 'org.xmlcml.cml.element.CMLMatrix.getUnit(NamespaceToUnitListMap)'
     */
    @Test
