...
public class CMLCrystalTest extends AbstractTest {
    ...
    public void testSetCellParametersDoubleDoubleDoubleDoubleDoubleDouble() {
        ...
        try {
            ...
            Assert.assertEquals("should not throw ",
                    "org.xmlcml.cml.base.CMLRuntime: no cell params", "" + e);
        }
    ...
    public void testSetCellParametersDoubleArray() {
        try {
            crystal1
                    .setCellParameters(new double[] { 10, 11, 12, 80, 90, 100 });
        } catch (CMLException e) {
            Assert.fail("should not throw " + e);
        }
        List<CMLScalar> cell = null;
    ...
    public void testGetCellScalars() {
        double[] param = null;
        try {
            param = crystal2.getCellParameterValues();
        } catch (CMLException e) {
            neverThrow(e);
        }
