...
public class SVGTextTest {
	...
	public void testSetup() {
		Element element = TstUtils.parseValidString(STRING1);
	...
	public void testApplyTransform() {
		...
		TstUtils.assertEqualsIncludingFloat("transform", expected, text, true, 0.001);
	}
	...
	public void testGetEstimatedHorizontalLength() {
		...
		"x='1.0' y='2.0' xmlns='http://www.w3.org/2000/svg'>string</text>";
		SVGText text1 = (SVGText) SVGElement.createSVG(TstUtils.parseValidString(test1S));
		...
		String s = "" +
				...
				"</svg>";
		SVGSVG svg = (SVGSVG) SVGElement.createSVG(TstUtils.parseValidString(s));
...
//		}
	...
	public void testGetCalculatedTextEnd() {
		...
		SVGText text = (SVGText) SVGElement.createSVG(TstUtils.parseValidString("<text style=\"font-family:'Helvetica',sans-serif;font-size:6.2023;stroke:none;fill:black;\" " +
		...
		text = (SVGText) SVGElement.createSVG(TstUtils.parseValidString(
	...
	public void testGetCurrentFontSize() {
		SVGText text = (SVGText) SVGElement.createSVG(TstUtils.parseValidString(
			"<text style=\"font-family:'Helvetica',sans-serif;font-size:6.2023;stroke:none;fill:black;\" " +
		"improper=\"true\" x=\"3.0\" y=\"30.\">ppm</text>"));
...
<g class="peak">
  ...
  */
		SVGText text0 = (SVGText) SVGElement.createSVG(TstUtils.parseValidString(
		...
		SVGText text2 = (SVGText) SVGElement.createSVG(TstUtils.parseValidString(
				"  <text style=\"font-family:'Helvetica',sans-serif;font-size:5.7793;stroke:none;fill:black;\" " +
...
<g>
  ...
  */
		...
		SVGText text4 = (SVGText) SVGElement.createSVG(TstUtils.parseValidString(
				"<text style=\"font-family:'Helvetica',sans-serif;font-size:7.7348;stroke:none;fill:black;\" " +
		...
		SVGText text6 = (SVGText) SVGElement.createSVG(TstUtils.parseValidString(
				"<text style=\"font-family:'Helvetica',sans-serif;font-size:7.7348;stroke:none;fill:black;\" " +
