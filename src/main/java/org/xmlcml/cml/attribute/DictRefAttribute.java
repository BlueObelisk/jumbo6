...
//    }
    ...
    /** checks an element recursively for valid dictRefs. 
     * checks that all dictRefs in a element resolve.
     * 
     * @param element to check (at present only CML elements are checked)
     * @param dictionaryMap
...
//            errorList.addAll(check((CMLElement)element, ICMLScalar.TAGX, NAME, dictionaryMap));
//            errorList.addAll(check((CMLElement)element, ICMLArray.TAGX, NAME, dictionaryMap));
//            errorList.addAll(check((CMLElement)element, ICMLMatrix.TAGX, NAME, dictionaryMap));
//            errorList.addAll(check((CMLElement)element, ICMLParameter.TAGX, NAME, dictionaryMap));
//            errorList.addAll(check((CMLElement)element, ICMLProperty.TAGX, NAME, dictionaryMap));
        }
        return errorList;
    }
