...
//    		this.removeAttribute(att.getLocalName());
    ...
    public void removeNamespaceDeclaration(String prefix) {
        String namespaceURI = this.getNamespaceURI(prefix);
        if (namespaceURI == null) {
            throw new CMLRuntimeException("Cannot remove namespace prefix");
        }
    }
...
//  parent.addAttribute(new Attribute(parentAttribute, attValue));
    ...
    */
     ...
     *             standard message
     */
    protected void unknownAttributeName(String name) throws CMLException {
        throw new CMLException("Unknown CML attribute " + name + " on "
                + this.getLocalName());
    }
    ...
    protected CMLElement getOrCreateChild(String name) throws CMLRuntimeException {
