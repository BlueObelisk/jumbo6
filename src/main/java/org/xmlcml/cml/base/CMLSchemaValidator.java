...
public class CMLSchemaValidator {
     ...
     */
    public static CMLSchemaValidator getInstance() throws IOException, CMLException {
        if (instance == null) {
            createInstance();
        }
        return instance;
    ...
    private static synchronized void createInstance() throws IOException, CMLException {
        if (instance == null) {
            instance = new CMLSchemaValidator();
        }
    }

    private CMLSchemaValidator() throws IOException, CMLException {
        ...
        try {
            ...
            throw new CMLException("invalid schema", e);
        } finally {
            is.close();
        }
    }
     ...
     */
    public void validateCML(Source source) throws IOException, CMLException {
        Validator validator = schema.newValidator();
        try {
            validator.validate(source);
        } catch (SAXException e) {
            throw new CMLException("not valid CML", e);
        }
    }
     ...
     * @throws CMLException
     */
    public void validateCML(InputStream in) throws IOException, CMLException {
     ...
     * @throws CMLException
     */
    public void validateCML(Reader in) throws IOException, CMLException {
        validateCML(new StreamSource(in));
    }
     ...
     * @throws CMLException
     */
    public void validateCML(nu.xom.Document d) throws IOException, CMLException {
     ...
     * @throws CMLException
     */
    public void validateCML(nu.xom.Node node) throws IOException, CMLException {
        ValidatorHandler handler = schema.newValidatorHandler();
        SAXConverter converter = new SAXConverter(handler);
        try {
     ...
     * @throws CMLException
     */
    public void validateCML(org.w3c.dom.Node node) throws IOException, CMLException {
