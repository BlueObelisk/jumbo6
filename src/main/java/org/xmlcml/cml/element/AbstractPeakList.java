...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractPeakList extends CMLElement {
    /** local name*/
    public final static String TAG = "peakList";
    /** constructor. */    public AbstractPeakList() {
        super("peakList");
    }
/** copy constructor.
...
*/
    public AbstractPeakList(AbstractPeakList old) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "peakList");
            if (_att_dictref == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "peakList");
            if (_att_convention == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "peakList");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "peakList");
            if (_att_id == null) {
...
// attribute:   ref
    ...
    */
    public void setRef(String value) throws CMLRuntimeException {
        ...
        if (_att_ref == null) {
            _att_ref = (RefAttribute) attributeFactory.getAttribute("ref", "peakList");
            if (_att_ref == null) {
