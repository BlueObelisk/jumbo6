...
public abstract class AbstractPropertyList extends CMLElement {
    /** local name*/
    public final static String TAG = "propertyList";
    /** constructor. */    public AbstractPropertyList() {
        super("propertyList");
    }
/** copy constructor.
...
// element:   observation
    ...
    /** Role of the object.
    * How the object functions or its position in the architecture. No controlled vocabulary.
    * @param observation child to add
    */
    public void addObservation(AbstractObservation observation) {
        observation.detach();
        this.appendChild(observation);
    }
    /** Role of the object.
    * How the object functions or its position in the architecture. No controlled vocabulary.
    * @return CMLElements<CMLObservation>
    */
    public CMLElements<CMLObservation> getObservationElements() {
        Elements elements = this.getChildElements("observation", CML_NS);
        return new CMLElements<CMLObservation>(elements);
    }
