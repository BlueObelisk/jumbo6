...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractTableContent extends CMLElement {
    /** local name*/
    public final static String TAG = "tableContent";
    /** constructor. */    public AbstractTableContent() {
        super("tableContent");
    }
/** copy constructor.
...
*/
    public AbstractTableContent(AbstractTableContent old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "tableContent");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "tableContent");
            if (_att_id == null) {
    ...
    */
    public void setDelimiter(String value) throws CMLRuntimeException {
        ...
        if (_att_delimiter == null) {
            _att_delimiter = (DelimiterAttribute) attributeFactory.getAttribute("delimiter", "tableContent");
            if (_att_delimiter == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "tableContent");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "tableContent");
            if (_att_dictref == null) {
