...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractMetadataList extends CMLElement {
    /** local name*/
    public final static String TAG = "metadataList";
    /** constructor. */    public AbstractMetadataList() {
        super("metadataList");
    }
/** copy constructor.
...
*/
    public AbstractMetadataList(AbstractMetadataList old) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "metadataList");
            if (_att_id == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "metadataList");
            if (_att_title == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "metadataList");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "metadataList");
            if (_att_dictref == null) {
...
// attribute:   name
    ...
    */
    public void setName(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_name == null) {
            _att_name = (StringSTAttribute) attributeFactory.getAttribute("name", "metadataList");
            if (_att_name == null) {
...
// attribute:   role
    ...
    */
    public void setRole(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_role == null) {
            _att_role = (StringSTAttribute) attributeFactory.getAttribute("role", "metadataList");
            if (_att_role == null) {
