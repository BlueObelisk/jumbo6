...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractMetadata extends CMLElement {
    /** local name*/
    public final static String TAG = "metadata";
    /** constructor. */    public AbstractMetadata() {
        super("metadata");
    }
/** copy constructor.
...
*/
    public AbstractMetadata(AbstractMetadata old) {
        super((CMLElement) old);
    }
// attribute:   content

    /** cache */
    StringSTAttribute _att_content = null;
    /** content of metadata.
    * No description
    * @return CMLAttribute
    */
    public CMLAttribute getContentAttribute() {
        return (CMLAttribute) getAttribute("content");
    }
    /** content of metadata.
    * No description
    * @return String
    */
    public String getContent() {
        StringSTAttribute att = (StringSTAttribute) this.getContentAttribute();
        if (att == null) {
            return null;
        }
    ...
    */
    public void setContent(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_content == null) {
            _att_content = (StringSTAttribute) attributeFactory.getAttribute("content", "metadata");
            if (_att_content == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : content probably incompatible attributeGroupName and attributeName");
            }
        }
        att = new StringSTAttribute(_att_content);
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "metadata");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "metadata");
            if (_att_dictref == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "metadata");
            if (_att_id == null) {
...
// attribute:   name
    ...
    */
    public void setName(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_name == null) {
            _att_name = (StringSTAttribute) attributeFactory.getAttribute("name", "metadata");
            if (_att_name == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "metadata");
            if (_att_title == null) {
