...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractPotentialList extends CMLElement {
    /** local name*/
    public final static String TAG = "potentialList";
    /** constructor. */    public AbstractPotentialList() {
        super("potentialList");
    }
/** copy constructor.
...
*/
    public AbstractPotentialList(AbstractPotentialList old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "potentialList");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "potentialList");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "potentialList");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "potentialList");
            if (_att_dictref == null) {
...
// element:   potential
    ...
    /** null
    * @param potential child to add
    */
    public void addPotential(AbstractPotential potential) {
        potential.detach();
    ...
    */
    public CMLElements<CMLPotential> getPotentialElements() {
        Elements elements = this.getChildElements("potential", CML_NS);
        return new CMLElements<CMLPotential>(elements);
    }
