...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractTableRowList extends CMLElement {
    /** local name*/
    public final static String TAG = "tableRowList";
    /** constructor. */    public AbstractTableRowList() {
        super("tableRowList");
    }
/** copy constructor.
...
*/
    public AbstractTableRowList(AbstractTableRowList old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "tableRowList");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "tableRowList");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "tableRowList");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "tableRowList");
            if (_att_dictref == null) {
...
// element:   tableRow
    ...
    /** null
    * @param tableRow child to add
    */
    public void addTableRow(AbstractTableRow tableRow) {
        tableRow.detach();
