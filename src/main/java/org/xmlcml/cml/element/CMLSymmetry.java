...
//        }
    ...
    static CMLCrystal.Centering getCentering(List<CMLTransform3> transformList) {
        ...
        if (transformList.size() == 0) {
            ...
            if (transformList.get(0).isEqualTo(
                    CMLCrystal.Centering.A.translations.get(0), Real.EPS)) {
                centering = CMLCrystal.Centering.A;
            } else if (transformList.get(0).isEqualTo(
                    CMLCrystal.Centering.B.translations.get(0), Real.EPS)) {
                centering = CMLCrystal.Centering.B;
            } else if (transformList.get(0).isEqualTo(
                    CMLCrystal.Centering.C.translations.get(0), Real.EPS)) {
                centering = CMLCrystal.Centering.C;
            } else if (transformList.get(0).isEqualTo(
                    CMLCrystal.Centering.I.translations.get(0), Real.EPS)) {
    ...
    public static CMLSymmetry getContainedSymmetry(CMLElement element) throws CMLRuntimeException {
        ...
        if (symmetryNodes.size() == 0) {
            ...
            throw new CMLRuntimeException("TOO MANY <symmetry> FOUND "+symmetryNodes.size());
        }
