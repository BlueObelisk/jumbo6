...
public abstract class AbstractReactionStep extends CMLElement {
    ...
    /** constructor. */    public AbstractReactionStep() {
        super("reactionStep");
    }
/** copy constructor.
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "reactionStep");
            if (_att_dictref == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "reactionStep");
            if (_att_convention == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "reactionStep");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "reactionStep");
            if (_att_id == null) {
...
// attribute:   ref
    ...
    */
    public void setRef(String value) throws CMLRuntimeException {
        ...
        if (_att_ref == null) {
            _att_ref = (RefAttribute) attributeFactory.getAttribute("ref", "reactionStep");
            if (_att_ref == null) {
...
// attribute:   yield
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setYield(String value) throws CMLRuntimeException {
        DoubleSTAttribute att = null;
        if (_att_yield == null) {
            _att_yield = (DoubleSTAttribute) attributeFactory.getAttribute("yield", "reactionStep");
            if (_att_yield == null) {
...
// attribute:   ratio
    ...
    /** cache */
    DoubleSTAttribute _att_ratio = null;
    ...
    */
    public double getRatio() {
        DoubleSTAttribute att = (DoubleSTAttribute) this.getRatioAttribute();
        if (att == null) {
            return Double.NaN;
        }
        return att.getDouble();
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setRatio(String value) throws CMLRuntimeException {
        DoubleSTAttribute att = null;
        if (_att_ratio == null) {
            _att_ratio = (DoubleSTAttribute) attributeFactory.getAttribute("ratio", "reactionStep");
            if (_att_ratio == null) {
        ...
        att = new DoubleSTAttribute(_att_ratio);
        super.addRemove(att, value);
    }
    /** A ratio in the range 0 to 1.
    * Currently used for ratios between brached reactions but re-usable for other concepts.
    ...
    */
    public void setRatio(double value) throws CMLRuntimeException {
        ...
        DoubleSTAttribute att = new DoubleSTAttribute(_att_ratio);
        super.addAttribute(att);
        att.setCMLValue(value);
    }
