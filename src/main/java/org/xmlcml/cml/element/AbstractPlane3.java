...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractPlane3 extends CMLElement {
    /** local name*/
    public final static String TAG = "plane3";
    /** constructor. */    public AbstractPlane3() {
        super("plane3");
    }
/** copy constructor.
...
*/
    public AbstractPlane3(AbstractPlane3 old) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "plane3");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "plane3");
            if (_att_dictref == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "plane3");
            if (_att_id == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "plane3");
            if (_att_title == null) {
...
// attribute:   units
    ...
    */
    public void setUnits(String value) throws CMLRuntimeException {
        ...
        if (_att_units == null) {
            _att_units = (UnitsAttribute) attributeFactory.getAttribute("units", "plane3");
            if (_att_units == null) {
