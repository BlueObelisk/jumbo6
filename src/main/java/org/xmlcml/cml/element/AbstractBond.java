...
// attribute:   cyclic
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setCyclic(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_cyclic == null) {
            _att_cyclic = (StringSTAttribute) attributeFactory.getAttribute("cyclic", "bond");
            if (_att_cyclic == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : cyclic probably incompatible attributeGroupName and attributeName");
            }
        }
