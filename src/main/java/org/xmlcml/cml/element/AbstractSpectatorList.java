...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractSpectatorList extends CMLElement {
    /** local name*/
    public final static String TAG = "spectatorList";
    /** constructor. */    public AbstractSpectatorList() {
        super("spectatorList");
    }
/** copy constructor.
...
*/
    public AbstractSpectatorList(AbstractSpectatorList old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "spectatorList");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "spectatorList");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "spectatorList");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "spectatorList");
            if (_att_dictref == null) {
...
// element:   spectator
    ...
    /** null
    * @param spectator child to add
    */
    public void addSpectator(AbstractSpectator spectator) {
        spectator.detach();
