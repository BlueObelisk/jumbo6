...
// fields;
    ...
    * @param old AbstractLatticeVector to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("periodic", "periodic");
    };
    ...
    */
    public String getPeriodic() {
        CMLAttribute _att_periodic = (CMLAttribute) getAttribute("periodic");
        if (_att_periodic == null) {
            return null;
        }
        return ((StringAttribute)_att_periodic).getString();
    }
    /** Is the axis periodic.
    *
    * Any or all of the axes may be periodic or aperiodic. An example could be a surface where 2 periodic axes (not necessarily orthogonal) are used to describe the coordinates in the surface, perhaps representing lattice vectors of a 3D crystal or 2D layer. The third vector is orthogonal and represents coordinates normal to the surface. In this case only the direction, not the magnitude of the vector is important.
    ...
    * @param value periodic value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setPeriodic(String value) throws CMLRuntimeException {
            CMLAttribute _att_periodic = null;
            try {
        		_att_periodic = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("periodic"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_periodic == null) {
            ...
            super.addAttribute(_att_periodic);
        ((StringAttribute)_att_periodic).setCMLValue(value);
    }
    /** add latticeVector element.
    *
