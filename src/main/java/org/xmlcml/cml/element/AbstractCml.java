...
// attribute:   fileId
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setFileId(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_fileid == null) {
            _att_fileid = (StringSTAttribute) attributeFactory.getAttribute("fileId", "cml");
            if (_att_fileid == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : fileId probably incompatible attributeGroupName and attributeName");
            }
        }
