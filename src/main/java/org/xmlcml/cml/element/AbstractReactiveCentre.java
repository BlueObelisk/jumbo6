...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractReactiveCentre extends CMLElement {
    /** local name*/
    public final static String TAG = "reactiveCentre";
    /** constructor. */    public AbstractReactiveCentre() {
        super("reactiveCentre");
    }
/** copy constructor.
* deep copy using XOM copy()
* @param old element to copy
*/
    public AbstractReactiveCentre(AbstractReactiveCentre old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "reactiveCentre");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "reactiveCentre");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "reactiveCentre");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "reactiveCentre");
            if (_att_dictref == null) {
...
// element:   atomTypeList
    ...
    /** null
    * @param atomTypeList child to add
    */
    public void addAtomTypeList(AbstractAtomTypeList atomTypeList) {
        atomTypeList.detach();
...
// element:   bondTypeList
    ...
    /** null
    * @param bondTypeList child to add
    */
    public void addBondTypeList(AbstractBondTypeList bondTypeList) {
        bondTypeList.detach();
...
// element:   atomSet
    ...
    /** null
    * @param atomSet child to add
    */
    public void addAtomSet(AbstractAtomSet atomSet) {
        atomSet.detach();
...
// element:   bondSet
    ...
    /** null
    * @param bondSet child to add
    */
    public void addBondSet(AbstractBondSet bondSet) {
        bondSet.detach();
