...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractSpectrumList extends CMLElement {
    /** local name*/
    public final static String TAG = "spectrumList";
    /** constructor. */    public AbstractSpectrumList() {
        super("spectrumList");
    }
/** copy constructor.
...
*/
    public AbstractSpectrumList(AbstractSpectrumList old) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "spectrumList");
            if (_att_dictref == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "spectrumList");
            if (_att_convention == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "spectrumList");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "spectrumList");
            if (_att_id == null) {
    ...
    */
    public void setMoleculeRef(String value) throws CMLRuntimeException {
        ...
        if (_att_moleculeref == null) {
            _att_moleculeref = (StringSTAttribute) attributeFactory.getAttribute("moleculeRef", "spectrumList");
            if (_att_moleculeref == null) {
...
// element:   spectrumList
    ...
    /** A reference to a molecule.
    * Used by spectrum, etc.
    * @param spectrumList child to add
    */
    public void addSpectrumList(AbstractSpectrumList spectrumList) {
        spectrumList.detach();
        this.appendChild(spectrumList);
    }
    /** A reference to a molecule.
    * Used by spectrum, etc.
