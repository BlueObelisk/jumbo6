...
// fields;
    ...
    * @param old AbstractSubstanceList to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("type", "substanceListType");
    ...
    */
    public void setType(String value) throws CMLRuntimeException {
            ...
            try {
        		_att_type = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("substanceListType"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_type == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : substanceListType; probably incompatible attributeGroupName and attributeName");
            }
    ...
    */
    ...
    /** add substanceList element.
    *
    * @param amount amount child to add
    ...
    */
    ...
    /** get substanceList child elements .
    *
