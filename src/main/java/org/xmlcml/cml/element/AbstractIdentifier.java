...
// attribute:   version
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setVersion(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_version == null) {
            _att_version = (StringSTAttribute) attributeFactory.getAttribute("version", "identifier");
            if (_att_version == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : version probably incompatible attributeGroupName and attributeName");
            }
        }
...
// attribute:   tautomeric
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setTautomeric(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_tautomeric == null) {
            _att_tautomeric = (StringSTAttribute) attributeFactory.getAttribute("tautomeric", "identifier");
            if (_att_tautomeric == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : tautomeric probably incompatible attributeGroupName and attributeName");
            }
        }
