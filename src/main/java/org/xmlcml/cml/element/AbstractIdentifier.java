...
// fields;
    ...
    * @param old AbstractIdentifier to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("version", "version");
        ...
        attributeGroupNameTable.put("tautomeric", "tautomeric");
    };
    ...
    */
    public String getVersion() {
        CMLAttribute _att_version = (CMLAttribute) getAttribute("version");
        if (_att_version == null) {
            return null;
        }
        return ((StringAttribute)_att_version).getString();
    }
    /** The version of the element.
    *
    ...
    */
    public void setVersion(String value) throws CMLRuntimeException {
            CMLAttribute _att_version = null;
            try {
        		_att_version = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("version"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_version == null) {
            ...
            super.addAttribute(_att_version);
        ((StringAttribute)_att_version).setCMLValue(value);
    }
    ...
    */
    public String getTautomeric() {
        CMLAttribute _att_tautomeric = (CMLAttribute) getAttribute("tautomeric");
        if (_att_tautomeric == null) {
            return null;
        }
        return ((StringAttribute)_att_tautomeric).getString();
    }
    /** Indicates whether the structure is a tautomer.
    *
    * @param value tautomeric value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setTautomeric(String value) throws CMLRuntimeException {
            CMLAttribute _att_tautomeric = null;
            try {
        		_att_tautomeric = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("tautomeric"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_tautomeric == null) {
            ...
            super.addAttribute(_att_tautomeric);
        ((StringAttribute)_att_tautomeric).setCMLValue(value);
    }
