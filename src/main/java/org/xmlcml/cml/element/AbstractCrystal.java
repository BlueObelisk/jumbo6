...
// fields;
    ...
    * @param old AbstractCrystal to copy
    ...
    */
    ...
    static {
        attributeGroupNameTable.put("z", "z");
    ...
    */
    public void setZ(int value) throws CMLRuntimeException {
            CMLAttribute _att_z = null;
            try {
        		_att_z = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("z"));
            ...
            super.addAttribute(_att_z);
        ((IntAttribute)_att_z).setCMLValue(value);
    }
    /** The number of molecules per cell.
    *
    * Molecules are defined as the _molecule_ which directly contains the _crystal_ element.
    ...
    */
    private void setZ(String value) throws CMLRuntimeException {
            CMLAttribute _att_z = new IntAttribute((IntAttribute)CMLAttributeList.getAttribute("z"));
            if (_att_z == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : z; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_z);
    ...
    */
    ...
    /** add crystal element.
    *
    * @param cellParameter cellParameter child to add
