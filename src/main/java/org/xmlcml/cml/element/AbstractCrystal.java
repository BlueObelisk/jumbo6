...
// attribute:   z
    ...
    */
    public int getZ() {
        ...
        if (att == null) {
            throw new CMLRuntimeException("int attribute is unset: z");
        }
        return att.getInt();
    }
    /** The number of molecules per cell.
    ...
    */
    public void setZ(String value) throws CMLRuntimeException {
        IntSTAttribute att = null;
        if (_att_z == null) {
            _att_z = (IntSTAttribute) attributeFactory.getAttribute("z", "crystal");
            if (_att_z == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : z probably incompatible attributeGroupName and attributeName");
            }
        }
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setZ(int value) throws CMLRuntimeException {
        if (_att_z == null) {
            _att_z = (IntSTAttribute) attributeFactory.getAttribute("z", "crystal");
           if (_att_z == null) {
               throw new CMLRuntimeException("BUG: cannot process attributeGroupName : z probably incompatible attributeGroupName and attributeName ");
