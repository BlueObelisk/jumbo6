...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractReactant extends CMLElement {
    /** local name*/
    public final static String TAG = "reactant";
    /** constructor. */    public AbstractReactant() {
        super("reactant");
    }
/** copy constructor.
...
*/
    public AbstractReactant(AbstractReactant old) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "reactant");
            if (_att_dictref == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "reactant");
            if (_att_convention == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "reactant");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "reactant");
            if (_att_id == null) {
...
// attribute:   ref
    ...
    */
    public void setRef(String value) throws CMLRuntimeException {
        ...
        if (_att_ref == null) {
            _att_ref = (RefAttribute) attributeFactory.getAttribute("ref", "reactant");
            if (_att_ref == null) {
...
// attribute:   role
    ...
    */
    public void setRole(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_role == null) {
            _att_role = (StringSTAttribute) attributeFactory.getAttribute("role", "reactant");
            if (_att_role == null) {
...
// attribute:   count
    ...
    */
    public void setCount(String value) throws CMLRuntimeException {
        ...
        if (_att_count == null) {
            _att_count = (DoubleSTAttribute) attributeFactory.getAttribute("count", "reactant");
            if (_att_count == null) {
...
// attribute:   state
    ...
    */
    public void setState(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_state == null) {
            _att_state = (StringSTAttribute) attributeFactory.getAttribute("state", "reactant");
            if (_att_state == null) {
