...
//    static int count = 0;
     ...
     * @param bond to add
     * @return added bond or null
     * @throws CMLRuntimeException if already child or duplicate hash or not part of molecule
     */
    ...
    public CMLBond insertBond(CMLBond bond, int pos) {
        ...
        if (parent != null) {
            if (parent.equals(this)) {
                throw new CMLRuntimeException("bond already added "+bond.getString());
            }
        } else {
            if (this.getMolecule() == null) {
                throw new CMLRuntimeException("bondArray parent must be molecule");
            }
        }
    ...
    public void indexBonds() {
        ...
        if (molecule == null) {
            throw new CMLRuntimeException("Cannot index bonds without molecule");
        }
        CMLAtomArray atomArray = molecule.getAtomArray();
        if (atomArray == null) {
            throw new CMLRuntimeException("Cannot index bonds without atoms");
        }
