...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractModule extends CMLElement {
    /** local name*/
    public final static String TAG = "module";
    /** constructor. */    public AbstractModule() {
        super("module");
    }
/** copy constructor.
...
*/
    public AbstractModule(AbstractModule old) {
        super((CMLElement) old);
    }
// attribute:   serial

    /** cache */
    StringSTAttribute _att_serial = null;
    /** Serial number or other id.
    * No description
    * @return CMLAttribute
    */
    public CMLAttribute getSerialAttribute() {
        return (CMLAttribute) getAttribute("serial");
    }
    /** Serial number or other id.
    * No description
    * @return String
    */
    public String getSerial() {
        StringSTAttribute att = (StringSTAttribute) this.getSerialAttribute();
        if (att == null) {
            return null;
        }
    ...
    */
    public void setSerial(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_serial == null) {
            _att_serial = (StringSTAttribute) attributeFactory.getAttribute("serial", "module");
            if (_att_serial == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : serial probably incompatible attributeGroupName and attributeName");
            }
        }
        att = new StringSTAttribute(_att_serial);
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "module");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "module");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "module");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "module");
            if (_att_dictref == null) {
...
// attribute:   role
    ...
    */
    public void setRole(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_role == null) {
            _att_role = (StringSTAttribute) attributeFactory.getAttribute("role", "module");
            if (_att_role == null) {
