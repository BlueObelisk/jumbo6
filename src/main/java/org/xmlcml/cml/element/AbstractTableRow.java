...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractTableRow extends CMLElement {
    /** local name*/
    public final static String TAG = "tableRow";
    /** constructor. */    public AbstractTableRow() {
        super("tableRow");
    }
/** copy constructor.
...
*/
    public AbstractTableRow(AbstractTableRow old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "tableRow");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "tableRow");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "tableRow");
            if (_att_convention == null) {
...
// element:   tableCell
    ...
    /** null
    * @param tableCell child to add
    */
    public void addTableCell(AbstractTableCell tableCell) {
        tableCell.detach();
    ...
    */
    public CMLElements<CMLTableCell> getTableCellElements() {
        Elements elements = this.getChildElements("tableCell", CML_NS);
        return new CMLElements<CMLTableCell>(elements);
    }
