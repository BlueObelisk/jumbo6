...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractVector3 extends CMLElement {
    /** local name*/
    public final static String TAG = "vector3";
    /** constructor. */    public AbstractVector3() {
        super("vector3");
    }
/** copy constructor.
...
*/
    public AbstractVector3(AbstractVector3 old) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "vector3");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "vector3");
            if (_att_dictref == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "vector3");
            if (_att_id == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "vector3");
            if (_att_title == null) {
...
// attribute:   units
    ...
    */
    public void setUnits(String value) throws CMLRuntimeException {
        ...
        if (_att_units == null) {
            _att_units = (UnitsAttribute) attributeFactory.getAttribute("units", "vector3");
            if (_att_units == null) {
