...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractTableHeader extends CMLElement {
    /** local name*/
    public final static String TAG = "tableHeader";
    /** constructor. */    public AbstractTableHeader() {
        super("tableHeader");
    }
/** copy constructor.
...
*/
    public AbstractTableHeader(AbstractTableHeader old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "tableHeader");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "tableHeader");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "tableHeader");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "tableHeader");
            if (_att_dictref == null) {
...
// element:   tableHeaderCell
    ...
    /** null
    * @param tableHeaderCell child to add
    */
    public void addTableHeaderCell(AbstractTableHeaderCell tableHeaderCell) {
    ...
    */
    public CMLElements<CMLTableHeaderCell> getTableHeaderCellElements() {
        Elements elements = this.getChildElements("tableHeaderCell", CML_NS);
        return new CMLElements<CMLTableHeaderCell>(elements);
    }
