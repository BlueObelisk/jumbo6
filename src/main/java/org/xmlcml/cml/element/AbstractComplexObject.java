...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractComplexObject extends CMLElement {
    /** local name*/
    public final static String TAG = "complexObject";
    /** constructor. */    public AbstractComplexObject() {
        super("complexObject");
    }
/** copy constructor.
...
*/
    public AbstractComplexObject(AbstractComplexObject old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "complexObject");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "complexObject");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "complexObject");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "complexObject");
            if (_att_dictref == null) {
