...
public abstract class AbstractSpectrumData extends CMLElement {
    /** local name*/
    public final static String TAG = "spectrumData";
    /** constructor. */    public AbstractSpectrumData() {
        super("spectrumData");
    }
/** copy constructor.
...
*/
    public AbstractSpectrumData(AbstractSpectrumData old) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "spectrumData");
            if (_att_dictref == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "spectrumData");
            if (_att_convention == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "spectrumData");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "spectrumData");
            if (_att_id == null) {
...
// attribute:   ref
    ...
    */
    public void setRef(String value) throws CMLRuntimeException {
        ...
        if (_att_ref == null) {
            _att_ref = (RefAttribute) attributeFactory.getAttribute("ref", "spectrumData");
            if (_att_ref == null) {
...
// element:   xaxis
    ...
    /** null
    * @param xaxis child to add
    */
    public void addXaxis(AbstractXaxis xaxis) {
        xaxis.detach();
    ...
    */
    public CMLElements<CMLXaxis> getXaxisElements() {
        Elements elements = this.getChildElements("xaxis", CML_NS);
        return new CMLElements<CMLXaxis>(elements);
    }
// element:   yaxis

    /** null
    * @param yaxis child to add
    */
    public void addYaxis(AbstractYaxis yaxis) {
        yaxis.detach();
    ...
    */
    public CMLElements<CMLYaxis> getYaxisElements() {
        Elements elements = this.getChildElements("yaxis", CML_NS);
        return new CMLElements<CMLYaxis>(elements);
    }
