...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractIntegerArray extends CMLElement {
    /** local name*/
    public final static String TAG = "integerArray";
    /** constructor. */    public AbstractIntegerArray() {
        super("integerArray");
    }
/** copy constructor.
...
*/
    public AbstractIntegerArray(AbstractIntegerArray old) {
    ...
    */
    public void setBuiltin(String value) throws CMLRuntimeException {
        ...
        if (_att_builtin == null) {
            _att_builtin = (StringSTAttribute) attributeFactory.getAttribute("builtin", "integerArray");
            if (_att_builtin == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "integerArray");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "integerArray");
            if (_att_dictref == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "integerArray");
            if (_att_id == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "integerArray");
            if (_att_title == null) {
...
// attribute:   min
    ...
    */
    public void setMin(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_min == null) {
            _att_min = (StringSTAttribute) attributeFactory.getAttribute("min", "integerArray");
            if (_att_min == null) {
...
// attribute:   max
    ...
    */
    public void setMax(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_max == null) {
            _att_max = (StringSTAttribute) attributeFactory.getAttribute("max", "integerArray");
            if (_att_max == null) {
...
// attribute:   size
    ...
    */
    public void setSize(String value) throws CMLRuntimeException {
        ...
        if (_att_size == null) {
            _att_size = (IntSTAttribute) attributeFactory.getAttribute("size", "integerArray");
            if (_att_size == null) {
...
// attribute:   units
    ...
    */
    public void setUnits(String value) throws CMLRuntimeException {
        ...
        if (_att_units == null) {
            _att_units = (UnitsAttribute) attributeFactory.getAttribute("units", "integerArray");
            if (_att_units == null) {
    ...
    */
    public void setUnitsRef(String value) throws CMLRuntimeException {
        ...
        if (_att_unitsref == null) {
            _att_unitsref = (StringSTAttribute) attributeFactory.getAttribute("unitsRef", "integerArray");
            if (_att_unitsref == null) {
