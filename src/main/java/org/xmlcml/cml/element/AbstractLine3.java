...
// attribute:   point3
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setPoint3(String value) throws CMLRuntimeException {
        DoubleArraySTAttribute att = null;
        if (_att_point3 == null) {
            _att_point3 = (DoubleArraySTAttribute) attributeFactory.getAttribute("point3", "line3");
            if (_att_point3 == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : point3 probably incompatible attributeGroupName and attributeName");
            }
        }
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setPoint3(double[] value) throws CMLRuntimeException {
        if (_att_point3 == null) {
            _att_point3 = (DoubleArraySTAttribute) attributeFactory.getAttribute("point3", "line3");
           if (_att_point3 == null) {
               throw new CMLRuntimeException("BUG: cannot process attributeGroupName : point3 probably incompatible attributeGroupName and attributeName ");
...
// attribute:   vector3
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setVector3(String value) throws CMLRuntimeException {
        DoubleArraySTAttribute att = null;
        if (_att_vector3 == null) {
            _att_vector3 = (DoubleArraySTAttribute) attributeFactory.getAttribute("vector3", "line3");
            if (_att_vector3 == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : vector3 probably incompatible attributeGroupName and attributeName");
            }
        }
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setVector3(double[] value) throws CMLRuntimeException {
        if (_att_vector3 == null) {
            _att_vector3 = (DoubleArraySTAttribute) attributeFactory.getAttribute("vector3", "line3");
           if (_att_vector3 == null) {
               throw new CMLRuntimeException("BUG: cannot process attributeGroupName : vector3 probably incompatible attributeGroupName and attributeName ");
