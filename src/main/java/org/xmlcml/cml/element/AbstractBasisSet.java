...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractBasisSet extends CMLElement {
    /** local name*/
    public final static String TAG = "basisSet";
    /** constructor. */    public AbstractBasisSet() {
        super("basisSet");
    }
/** copy constructor.
...
*/
    public AbstractBasisSet(AbstractBasisSet old) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "basisSet");
            if (_att_dictref == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "basisSet");
            if (_att_convention == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "basisSet");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "basisSet");
            if (_att_id == null) {
...
// attribute:   ref
    ...
    */
    public void setRef(String value) throws CMLRuntimeException {
        ...
        if (_att_ref == null) {
            _att_ref = (RefAttribute) attributeFactory.getAttribute("ref", "basisSet");
            if (_att_ref == null) {
...
// attribute:   role
    ...
    */
    public void setRole(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_role == null) {
            _att_role = (StringSTAttribute) attributeFactory.getAttribute("role", "basisSet");
            if (_att_role == null) {
...
// element:   atomicBasisFunction
    ...
    /** Role of the object.
    * How the object functions or its position in the architecture. No controlled vocabulary.
    * @param atomicBasisFunction child to add
    */
    public void addAtomicBasisFunction(AbstractAtomicBasisFunction atomicBasisFunction) {
        atomicBasisFunction.detach();
        this.appendChild(atomicBasisFunction);
    }
    /** Role of the object.
    * How the object functions or its position in the architecture. No controlled vocabulary.
    ...
    */
    public CMLElements<CMLAtomicBasisFunction> getAtomicBasisFunctionElements() {
        Elements elements = this.getChildElements("atomicBasisFunction", CML_NS);
        return new CMLElements<CMLAtomicBasisFunction>(elements);
    }
