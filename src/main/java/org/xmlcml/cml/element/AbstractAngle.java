// CONTENT of type :nonNegativeAngleType
...
// fields;
    ...
    * @param old AbstractAngle to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("atomRefs3", "atomRefs3");
        attributeGroupNameTable.put("units", "angleUnits");
    ...
    */
    public String[] getAtomRefs3() {
        CMLAttribute _att_atomRefs3 = (CMLAttribute) getAttribute("atomRefs3");
        if (_att_atomRefs3 == null) {
            return null;
        }
        return ((StringArrayAttribute)_att_atomRefs3).getStringArray();
    }
    /** A list of three references to atoms.
    *
    * Typically used for defining angles, 
    ...
    * @param value atomRefs3 value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setAtomRefs3(String[] value) throws CMLRuntimeException {
            CMLAttribute _att_atomRefs3 = null;
            try {
        		_att_atomRefs3 = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("atomRefs3"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_atomRefs3 == null) {
            ...
            super.addAttribute(_att_atomRefs3);
        ((StringArrayAttribute)_att_atomRefs3).setCMLValue(value);
    }
    /** A list of three references to atoms.
    *
    * Typically used for defining angles, 
    ...
    */
    private void setAtomRefs3(String value) throws CMLRuntimeException {
            CMLAttribute _att_atomRefs3 = new StringArrayAttribute((StringArrayAttribute)CMLAttributeList.getAttribute("atomRefs3"));
            if (_att_atomRefs3 == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : atomRefs3; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_atomRefs3);
    ...
    */
    public void setUnits(String value) throws CMLRuntimeException {
            ...
            try {
        		_att_units = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("angleUnits"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_units == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : angleUnits; probably incompatible attributeGroupName and attributeName");
            }
    ...
    */
    public void setXMLContent(double value) throws CMLRuntimeException {
        if (_xmlContent == null) {
            ...
            _xmlContent.setSchemaType(CMLTypeList.getType("nonNegativeAngleType"));
        }
