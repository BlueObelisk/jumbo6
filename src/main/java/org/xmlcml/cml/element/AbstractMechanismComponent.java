...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractMechanismComponent extends CMLElement {
    /** local name*/
    public final static String TAG = "mechanismComponent";
    /** constructor. */    public AbstractMechanismComponent() {
...
*/
    public AbstractMechanismComponent(AbstractMechanismComponent old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "mechanismComponent");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "mechanismComponent");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "mechanismComponent");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "mechanismComponent");
            if (_att_dictref == null) {
