...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractMoleculeList extends CMLElement {
    /** local name*/
    public final static String TAG = "moleculeList";
    /** constructor. */    public AbstractMoleculeList() {
        super("moleculeList");
    }
/** copy constructor.
...
*/
    public AbstractMoleculeList(AbstractMoleculeList old) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "moleculeList");
            if (_att_dictref == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "moleculeList");
            if (_att_convention == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "moleculeList");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "moleculeList");
            if (_att_id == null) {
...
// attribute:   ref
    ...
    */
    public void setRef(String value) throws CMLRuntimeException {
        ...
        if (_att_ref == null) {
            _att_ref = (RefAttribute) attributeFactory.getAttribute("ref", "moleculeList");
            if (_att_ref == null) {
...
// element:   moleculeList
    ...
    /** null
    * @param moleculeList child to add
    */
    public void addMoleculeList(AbstractMoleculeList moleculeList) {
        moleculeList.detach();
