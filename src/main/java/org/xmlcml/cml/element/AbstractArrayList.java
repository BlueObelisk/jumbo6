...
// attribute:   shape
    ...
    */
    public void setShape(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_shape == null) {
            _att_shape = (StringSTAttribute) attributeFactory.getAttribute("shape", "arrayList");
            if (_att_shape == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : shape probably incompatible attributeGroupName and attributeName");
            }
        }
