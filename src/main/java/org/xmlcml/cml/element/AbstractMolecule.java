...
// attribute:   symmetryOriented
    ...
    */
    public boolean getSymmetryOriented() {
        ...
        if (att == null) {
            throw new CMLRuntimeException("boolean attribute is unset: symmetryOriented");
        }
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setSymmetryOriented(boolean value) throws CMLRuntimeException {
        if (_att_symmetryoriented == null) {
            _att_symmetryoriented = (BooleanSTAttribute) attributeFactory.getAttribute("symmetryOriented", "molecule");
           if (_att_symmetryoriented == null) {
               throw new CMLRuntimeException("BUG: cannot process attributeGroupName : symmetryOriented probably incompatible attributeGroupName and attributeName ");
