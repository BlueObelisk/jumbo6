...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractKpointList extends CMLElement {
    /** local name*/
    public final static String TAG = "kpointList";
    /** constructor. */    public AbstractKpointList() {
        super("kpointList");
    }
/** copy constructor.
...
*/
    public AbstractKpointList(AbstractKpointList old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "kpointList");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "kpointList");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "kpointList");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "kpointList");
            if (_att_dictref == null) {
...
// element:   kpoint
    ...
    /** null
    * @param kpoint child to add
    */
    public void addKpoint(AbstractKpoint kpoint) {
        kpoint.detach();
    ...
    */
    public CMLElements<CMLKpoint> getKpointElements() {
        Elements elements = this.getChildElements("kpoint", CML_NS);
        return new CMLElements<CMLKpoint>(elements);
    }
