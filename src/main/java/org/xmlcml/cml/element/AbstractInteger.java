...
public abstract class AbstractInteger extends CMLElement {
    ...
    /** constructor. */    public AbstractInteger() {
        super("integer");
    }
/** copy constructor.
    ...
    */
    public void setBuiltin(String value) throws CMLRuntimeException {
        ...
        if (_att_builtin == null) {
            _att_builtin = (StringSTAttribute) attributeFactory.getAttribute("builtin", "integer");
            if (_att_builtin == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "integer");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "integer");
            if (_att_dictref == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "integer");
            if (_att_id == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "integer");
            if (_att_title == null) {
...
// attribute:   min
    ...
    */
    public void setMin(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_min == null) {
            _att_min = (StringSTAttribute) attributeFactory.getAttribute("min", "integer");
            if (_att_min == null) {
...
// attribute:   max
    ...
    */
    public void setMax(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_max == null) {
            _att_max = (StringSTAttribute) attributeFactory.getAttribute("max", "integer");
            if (_att_max == null) {
...
// attribute:   units
    ...
    */
    public void setUnits(String value) throws CMLRuntimeException {
        ...
        if (_att_units == null) {
            _att_units = (UnitsAttribute) attributeFactory.getAttribute("units", "integer");
            if (_att_units == null) {
...
// attribute:   unitsRef
    ...
    */
    public void setUnitsRef(String value) throws CMLRuntimeException {
        ...
        if (_att_unitsref == null) {
            _att_unitsref = (StringSTAttribute) attributeFactory.getAttribute("unitsRef", "integer");
            if (_att_unitsref == null) {
    ...
    */
    public int getXMLContent() {
        ...
        if (_xmlContent == null) {
            _xmlContent = new IntSTAttribute("_xmlContent");
        }
        _xmlContent.setCMLValue(content);
        return _xmlContent.getInt();
    }
    /** 
    * 
    * @param value title value
