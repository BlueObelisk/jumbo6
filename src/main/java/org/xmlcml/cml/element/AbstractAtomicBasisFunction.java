...
// attribute:   n
    ...
    */
    public int getN() {
        ...
        if (att == null) {
            throw new CMLRuntimeException("int attribute is unset: n");
        }
        return att.getInt();
    }
    /** The principal quantum number.
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setN(String value) throws CMLRuntimeException {
...
// attribute:   l
    ...
    */
    public int getL() {
        ...
        if (att == null) {
            throw new CMLRuntimeException("int attribute is unset: l");
        }
        return att.getInt();
    }
    /** The secondary quantum number.
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setL(String value) throws CMLRuntimeException {
        IntSTAttribute att = null;
        if (_att_l == null) {
...
// attribute:   m
    ...
    */
    public int getM() {
        ...
        if (att == null) {
            throw new CMLRuntimeException("int attribute is unset: m");
        }
        return att.getInt();
    }
    /** The azimuthal quantum number.
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setM(String value) throws CMLRuntimeException {
        IntSTAttribute att = null;
        if (_att_m == null) {
