...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractUnitTypeList extends CMLElement {
    /** local name*/
    public final static String TAG = "unitTypeList";
    /** constructor. */    public AbstractUnitTypeList() {
        super("unitTypeList");
    }
/** copy constructor.
...
*/
    public AbstractUnitTypeList(AbstractUnitTypeList old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "unitTypeList");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "unitTypeList");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "unitTypeList");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "unitTypeList");
            if (_att_dictref == null) {
    ...
    */
    public void setNamespace(String value) throws CMLRuntimeException {
        ...
        if (_att_namespace == null) {
            _att_namespace = (StringSTAttribute) attributeFactory.getAttribute("namespace", "unitTypeList");
            if (_att_namespace == null) {
    ...
    */
    public void setSiNamespace(String value) throws CMLRuntimeException {
        ...
        if (_att_sinamespace == null) {
            _att_sinamespace = (StringSTAttribute) attributeFactory.getAttribute("siNamespace", "unitTypeList");
            if (_att_sinamespace == null) {
    ...
    */
    public void setDictionaryPrefix(String value) throws CMLRuntimeException {
        ...
        if (_att_dictionaryprefix == null) {
            _att_dictionaryprefix = (StringSTAttribute) attributeFactory.getAttribute("dictionaryPrefix", "unitTypeList");
            if (_att_dictionaryprefix == null) {
...
// attribute:   href
    ...
    */
    public void setHref(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_href == null) {
            _att_href = (StringSTAttribute) attributeFactory.getAttribute("href", "unitTypeList");
            if (_att_href == null) {
