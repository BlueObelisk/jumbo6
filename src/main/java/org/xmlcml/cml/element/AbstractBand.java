...
// attribute:   kpoint
    ...
    */
    public void setKpoint(String value) throws CMLRuntimeException {
        DoubleArraySTAttribute att = null;
        if (_att_kpoint == null) {
            _att_kpoint = (DoubleArraySTAttribute) attributeFactory.getAttribute("kpoint", "band");
            if (_att_kpoint == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : kpoint probably incompatible attributeGroupName and attributeName");
            }
        }
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setKpoint(double[] value) throws CMLRuntimeException {
        if (_att_kpoint == null) {
            _att_kpoint = (DoubleArraySTAttribute) attributeFactory.getAttribute("kpoint", "band");
           if (_att_kpoint == null) {
               throw new CMLRuntimeException("BUG: cannot process attributeGroupName : kpoint probably incompatible attributeGroupName and attributeName ");
...
// attribute:   kpointRef
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setKpointRef(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_kpointref == null) {
            _att_kpointref = (StringSTAttribute) attributeFactory.getAttribute("kpointRef", "band");
            if (_att_kpointref == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : kpointRef probably incompatible attributeGroupName and attributeName");
            }
        }
...
// attribute:   weight
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setWeight(String value) throws CMLRuntimeException {
