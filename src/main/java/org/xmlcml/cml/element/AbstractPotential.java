...
public abstract class AbstractPotential extends CMLElement {
    /** local name*/
    public final static String TAG = "potential";
    /** constructor. */    public AbstractPotential() {
        super("potential");
    }
/** copy constructor.
...
*/
    public AbstractPotential(AbstractPotential old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "potential");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "potential");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "potential");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "potential");
            if (_att_dictref == null) {
...
// attribute:   form
    ...
    /** cache */
    StringSTAttribute _att_form = null;
    ...
    */
    public String getForm() {
        StringSTAttribute att = (StringSTAttribute) this.getFormAttribute();
        if (att == null) {
            return null;
        }
        return att.getString();
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setForm(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_form == null) {
            _att_form = (StringSTAttribute) attributeFactory.getAttribute("form", "potential");
            if (_att_form == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : form probably incompatible attributeGroupName and attributeName");
            }
        }
        att = new StringSTAttribute(_att_form);
        super.addRemove(att, value);
    }
// element:   arg
