...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractString extends CMLElement {
    /** local name*/
    public final static String TAG = "string";
    /** constructor. */    public AbstractString() {
        super("string");
    }
/** copy constructor.
...
*/
    public AbstractString(AbstractString old) {
    ...
    */
    public void setBuiltin(String value) throws CMLRuntimeException {
        ...
        if (_att_builtin == null) {
            _att_builtin = (StringSTAttribute) attributeFactory.getAttribute("builtin", "string");
            if (_att_builtin == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "string");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "string");
            if (_att_dictref == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "string");
            if (_att_id == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "string");
            if (_att_title == null) {
