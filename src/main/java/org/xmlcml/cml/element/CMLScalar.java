...
public class CMLScalar extends AbstractScalar implements HasUnits {
     ...
     * @return CMLScalar
     */
    public static CMLScalar makeElementInContext(Element parent) {
    ...
    public double getDouble() {
        ...
        if (getDataType().equals(XSD_DOUBLE)) {
            ...
            if (content != null) {
                result = new Double(content).doubleValue();
            }
        }
        return result;
    }
        ...
        if (getDataType().equals(XSD_INTEGER)) {
            ...
            if (content != null && !content.trim().equals(S_EMPTY)) {
                try {
                    ...
                    throw new CMLRuntimeException("bad integer content: "+content);
                }
            }
        } else {
            throw new CMLRuntimeException("wrong dataType for int " + getDataType());
        }
        return result;
    }
    ...
    public void setDataType(String dType) {
        if (this.getAttribute("dataType") == null) {
            ...
            throw new CMLRuntimeException("Must not reset dataType; use SetValue(...)");
        }
    }
        ...
        if (!this.getDataType().equals(scalar.getDataType())) {
            throw new CMLException(
                    "Unsuitable dataTypes for numeric operations / "
                            + this.getDataType() + "/" + scalar.getDataType());
        }
    }
