    ...
    */
    public void setBondID(String value) throws CMLRuntimeException {
        ...
        if (_att_bondid == null) {
            ...
            if (_att_bondid == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : bondID probably incompatible attributeGroupName and attributeName");
            }
        }
    ...
    */
    public void setAtomRef1(String value) throws CMLRuntimeException {
        ...
        if (_att_atomref1 == null) {
            ...
            if (_att_atomref1 == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : atomRef1 probably incompatible attributeGroupName and attributeName");
            }
        }
    ...
    */
    public void setAtomRef2(String value) throws CMLRuntimeException {
        ...
        if (_att_atomref2 == null) {
            ...
            if (_att_atomref2 == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : atomRef2 probably incompatible attributeGroupName and attributeName");
            }
        }
