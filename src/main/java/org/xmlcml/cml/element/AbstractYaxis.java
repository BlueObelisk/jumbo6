...
public abstract class AbstractYaxis extends CMLElement {
    ...
    /** constructor. */    public AbstractYaxis() {
        super("yaxis");
    }
/** copy constructor.
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "yaxis");
            if (_att_dictref == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "yaxis");
            if (_att_convention == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "yaxis");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "yaxis");
            if (_att_id == null) {
...
// attribute:   ref
    ...
    */
    public void setRef(String value) throws CMLRuntimeException {
        ...
        if (_att_ref == null) {
            _att_ref = (RefAttribute) attributeFactory.getAttribute("ref", "yaxis");
            if (_att_ref == null) {
    ...
    */
    public void setMultiplierToData(String value) throws CMLRuntimeException {
        ...
        if (_att_multipliertodata == null) {
            _att_multipliertodata = (DoubleSTAttribute) attributeFactory.getAttribute("multiplierToData", "yaxis");
            if (_att_multipliertodata == null) {
...
// attribute:   constantToData
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setConstantToData(String value) throws CMLRuntimeException {
        DoubleSTAttribute att = null;
        if (_att_constanttodata == null) {
            _att_constanttodata = (DoubleSTAttribute) attributeFactory.getAttribute("constantToData", "yaxis");
            if (_att_constanttodata == null) {
