...
public abstract class AbstractLength extends CMLElement {
    ...
    /** constructor. */    public AbstractLength() {
        super("length");
    }
/** copy constructor.
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "length");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "length");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "length");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "length");
            if (_att_dictref == null) {
    ...
    */
    public void setAtomRefs2(String value) throws CMLRuntimeException {
        ...
        if (_att_atomrefs2 == null) {
            _att_atomrefs2 = (StringArraySTAttribute) attributeFactory.getAttribute("atomRefs2", "length");
            if (_att_atomrefs2 == null) {
...
// attribute:   units
    ...
    */
    public void setUnits(String value) throws CMLRuntimeException {
        ...
        if (_att_units == null) {
            _att_units = (UnitsAttribute) attributeFactory.getAttribute("units", "length");
            if (_att_units == null) {
...
// attribute:   errorValue
    ...
    * @throws CMLRuntimeException attribute wrong value/type
    */
    public void setErrorValue(String value) throws CMLRuntimeException {
        DoubleSTAttribute att = null;
        if (_att_errorvalue == null) {
            _att_errorvalue = (DoubleSTAttribute) attributeFactory.getAttribute("errorValue", "length");
            if (_att_errorvalue == null) {
    ...
    */
    public void setErrorBasis(String value) throws CMLRuntimeException {
        ...
        if (_att_errorbasis == null) {
            _att_errorbasis = (StringSTAttribute) attributeFactory.getAttribute("errorBasis", "length");
            if (_att_errorbasis == null) {
...
// attribute:   max
    ...
    */
    public void setMax(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_max == null) {
            _att_max = (StringSTAttribute) attributeFactory.getAttribute("max", "length");
            if (_att_max == null) {
...
// attribute:   ref
    ...
    */
    public void setRef(String value) throws CMLRuntimeException {
        ...
        if (_att_ref == null) {
            _att_ref = (RefAttribute) attributeFactory.getAttribute("ref", "length");
            if (_att_ref == null) {
