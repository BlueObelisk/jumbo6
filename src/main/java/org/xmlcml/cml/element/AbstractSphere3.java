...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractSphere3 extends CMLElement {
    /** local name*/
    public final static String TAG = "sphere3";
    /** constructor. */    public AbstractSphere3() {
        super("sphere3");
    }
/** copy constructor.
...
*/
    public AbstractSphere3(AbstractSphere3 old) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "sphere3");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "sphere3");
            if (_att_dictref == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "sphere3");
            if (_att_id == null) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "sphere3");
            if (_att_title == null) {
...
// attribute:   units
    ...
    */
    public void setUnits(String value) throws CMLRuntimeException {
        ...
        if (_att_units == null) {
            _att_units = (UnitsAttribute) attributeFactory.getAttribute("units", "sphere3");
            if (_att_units == null) {
