...
// end of part 1
/** CLASS DOCUMENTATION */
public abstract class AbstractObject extends CMLElement {
    /** local name*/
    public final static String TAG = "object";
    /** constructor. */    public AbstractObject() {
        super("object");
    }
/** copy constructor.
...
*/
    public AbstractObject(AbstractObject old) {
...
// attribute:   title
    ...
    */
    public void setTitle(String value) throws CMLRuntimeException {
        ...
        if (_att_title == null) {
            _att_title = (StringSTAttribute) attributeFactory.getAttribute("title", "object");
            if (_att_title == null) {
...
// attribute:   id
    ...
    */
    public void setId(String value) throws CMLRuntimeException {
        ...
        if (_att_id == null) {
            _att_id = (IdAttribute) attributeFactory.getAttribute("id", "object");
            if (_att_id == null) {
    ...
    */
    public void setConvention(String value) throws CMLRuntimeException {
        ...
        if (_att_convention == null) {
            _att_convention = (StringSTAttribute) attributeFactory.getAttribute("convention", "object");
            if (_att_convention == null) {
    ...
    */
    public void setDictRef(String value) throws CMLRuntimeException {
        ...
        if (_att_dictref == null) {
            _att_dictref = (DictRefAttribute) attributeFactory.getAttribute("dictRef", "object");
            if (_att_dictref == null) {
...
// attribute:   name
    ...
    */
    public void setName(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_name == null) {
            _att_name = (StringSTAttribute) attributeFactory.getAttribute("name", "object");
            if (_att_name == null) {
...
// attribute:   type
    ...
    */
    public void setType(String value) throws CMLRuntimeException {
        StringSTAttribute att = null;
        if (_att_type == null) {
            _att_type = (StringSTAttribute) attributeFactory.getAttribute("type", "object");
            if (_att_type == null) {
...
// attribute:   count
    ...
    */
    public void setCount(String value) throws CMLRuntimeException {
        ...
        if (_att_count == null) {
            _att_count = (DoubleSTAttribute) attributeFactory.getAttribute("count", "object");
            if (_att_count == null) {
