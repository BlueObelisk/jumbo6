...
public class CMLLattice extends AbstractLattice {
     ...
     * @return CMLLattice
     */
    public static CMLLattice makeElementInContext(Element parent) {
    ...
    public CMLLattice(CMLLatticeVector[] lv) {
        ...
        if (lv == null || lv.length != 3) {
            throw new CMLRuntimeException("Invalid latticeVectors");
        }
    ...
    void addLatticeVectors(CMLLatticeVector a, CMLLatticeVector b,
            CMLLatticeVector c) {
        if (a == null) {
            throw new CMLRuntimeException("Null latticeVector");
        }
        this.appendChild(a);
        if (b == null) {
            throw new CMLRuntimeException("Null latticeVector");
    ...
    public double getVolume() {
        ...
        if (latticeVectors.size() != 3) {
            throw new CMLRuntimeException("Cannot calculate volume without vectors");
        }
    ...
    public CMLLattice getReducedCell() {
        if (Math.abs(this.getVolume()) < EPS) {
            throw new CMLRuntimeException("coplanar vectors");
        }
