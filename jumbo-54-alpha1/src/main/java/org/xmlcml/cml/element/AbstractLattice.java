...
// fields;
    ...
    * @param old AbstractLattice to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("latticeType", "latticeType");
        attributeGroupNameTable.put("spaceType", "spaceType");
    };
    ...
    */
    public String getLatticeType() {
        CMLAttribute _att_latticeType = (CMLAttribute) getAttribute("latticeType");
        if (_att_latticeType == null) {
            return null;
        }
        return ((StringAttribute)_att_latticeType).getString();
    }
    /** The primitivity of a lattice.
    *
    * No default. The semantics of this are software-dependent (i.e. this Schema does not check for consistency between spacegroups, symmetry operators, etc.
    ...
    * @param value latticeType value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setLatticeType(String value) throws CMLRuntimeException {
            CMLAttribute _att_latticeType = null;
            try {
        		_att_latticeType = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("latticeType"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_latticeType == null) {
            ...
            super.addAttribute(_att_latticeType);
        ((StringAttribute)_att_latticeType).setCMLValue(value);
    }
    ...
    */
    public String getSpaceType() {
        CMLAttribute _att_spaceType = (CMLAttribute) getAttribute("spaceType");
        if (_att_spaceType == null) {
            return null;
        }
        return ((StringAttribute)_att_spaceType).getString();
    }
    /** The spaceType of the lattice.
    *
    * Usually real or reciprocal. No default. The semantics of this are software-dependent (i.e. this Schema does not check for consistency for unitTypes, etc.
    ...
    * @param value spaceType value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setSpaceType(String value) throws CMLRuntimeException {
            CMLAttribute _att_spaceType = null;
            try {
        		_att_spaceType = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("spaceType"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_spaceType == null) {
            ...
            super.addAttribute(_att_spaceType);
        ((StringAttribute)_att_spaceType).setCMLValue(value);
    }
    /** add lattice element.
    *
    ...
    */
    ...
    /** add lattice element.
    *
    * @param latticeVector latticeVector child to add
