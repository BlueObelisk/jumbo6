...
// fields;
    ...
    * @param old AbstractPotential to copy
    ...
    */
    ...
    static {
        ...
        attributeGroupNameTable.put("form", "form");
    };
    ...
    */
    public String getForm() {
        CMLAttribute _att_form = (CMLAttribute) getAttribute("form");
        if (_att_form == null) {
            return null;
        }
        return ((StringAttribute)_att_form).getString();
    }
    /** A reference to a functional form.
    *
    * Currently used for potential.
    ...
    */
    public void setForm(String value) throws CMLRuntimeException {
            CMLAttribute _att_form = null;
            try {
        		_att_form = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("form"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_form == null) {
            ...
            super.addAttribute(_att_form);
        ((StringAttribute)_att_form).setCMLValue(value);
    }
    /** add potential element.
    *
