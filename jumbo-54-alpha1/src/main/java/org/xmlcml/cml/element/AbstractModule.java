...
// fields;
    ...
    * @param old AbstractModule to copy
    ...
    */
    ...
    static {
        attributeGroupNameTable.put("serial", "serial");
    ...
    */
    public String getSerial() {
        CMLAttribute _att_serial = (CMLAttribute) getAttribute("serial");
        if (_att_serial == null) {
            return null;
        }
        return ((StringAttribute)_att_serial).getString();
    }
    /** Currently only on module. Modules with the same _role_ attribute can be distinguished by _serial_. This is often an integer but other schemes may be used.
    *
    * @param value serial value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setSerial(String value) throws CMLRuntimeException {
            CMLAttribute _att_serial = null;
            try {
        		_att_serial = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("serial"));
            ...
            super.addAttribute(_att_serial);
        ((StringAttribute)_att_serial).setCMLValue(value);
    }
