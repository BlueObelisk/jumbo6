...
// fields;
    ...
    * @param old AbstractBand to copy
    ...
    */
    ...
    static {
        attributeGroupNameTable.put("kpoint", "kpoint");
    ...
    */
    public double[] getKpoint() {
        CMLAttribute _att_kpoint = (CMLAttribute) getAttribute("kpoint");
        if (_att_kpoint == null) {
            return null;
        }
        return ((DoubleArrayAttribute)_att_kpoint).getDoubleArray();
    }
    /** The k vector.
    *
    * The k-vector with 3 components.
    ...
    * @param value kpoint value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setKpoint(double[] value) throws CMLRuntimeException {
            CMLAttribute _att_kpoint = null;
            try {
        		_att_kpoint = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("kpoint"));
            ...
            super.addAttribute(_att_kpoint);
        ((DoubleArrayAttribute)_att_kpoint).setCMLValue(value);
    }
    /** The k vector.
    *
    * The k-vector with 3 components.
    ...
    */
    private void setKpoint(String value) throws CMLRuntimeException {
            CMLAttribute _att_kpoint = new DoubleArrayAttribute((DoubleArrayAttribute)CMLAttributeList.getAttribute("kpoint"));
            if (_att_kpoint == null) {
                throw new CMLRuntimeException("BUG: cannot process attributeGroupName : kpoint; probably incompatible attributeGroupName and attributeName");
            }
            super.addAttribute(_att_kpoint);
    ...
    */
    public String getKpointRef() {
        CMLAttribute _att_kpointRef = (CMLAttribute) getAttribute("kpointRef");
        if (_att_kpointRef == null) {
            return null;
        }
        return ((StringAttribute)_att_kpointRef).getString();
    }
    /** A reference to a kpoint.
    *
    * Used by band, etc.
    ...
    * @param value kpointRef value
    * @throws CMLRuntimeException attribute wrong value/type

    */
    public void setKpointRef(String value) throws CMLRuntimeException {
            CMLAttribute _att_kpointRef = null;
            try {
        		_att_kpointRef = (CMLAttribute) org.xmlcml.cml.element.SpecialAttribute.createSubclassedAttribute(this, CMLAttributeList.getAttribute("kpointRef"));
        	} catch (CMLException e) {
        		throw new CMLRuntimeException("bug "+e);
        	}
            if (_att_kpointRef == null) {
            ...
            super.addAttribute(_att_kpointRef);
        ((StringAttribute)_att_kpointRef).setCMLValue(value);
    }
