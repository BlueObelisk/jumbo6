...
// fields;
    ...
    * @param old AbstractTransform3 to copy
    ...
    */
    public void setXMLContent(double[] value) throws CMLRuntimeException {
        if (_xmlContent == null) {
            ...
            _xmlContent.setSchemaType(CMLTypeList.getType("matrix44Type"));
        }
