...
public class CMLBasisSet extends AbstractBasisSet {
     ...
     * @return CMLBasisSet
     */
    public static CMLBasisSet makeElementInContext(Element parent) {
    ...
    CMLBasisSet createBasisSet() {
        ...
        if (molecule != null && basis != null) {
            ...
            if (basis.equals(Basis.MINIMAL)) {
                ...
                throw new CMLRuntimeException("Unsupported basis set " + basis.value);
            }
        }
        return basisSet;
    }
     ...
     */
    public int getElectronCount() throws CMLException {
        int count = 0;
        if (molecule != null && basis != null) {
            List<CMLAtom> atoms = molecule.getAtoms();
            for (CMLAtom atom : atoms) {
                if (basis.equals(Basis.MINIMAL)) {
                    ...
                    throw new CMLException("Basis set not supported: " + basis);
                }
            }
