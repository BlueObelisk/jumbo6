...
public class RealArrayTest extends EuclidTest {
    ...
    public void testGetNormalDistribution() {
        ...
        int nsteps = 101;
        double sigma = 1.0;
        RealArray realArray = RealArray.getSymmetricalArray(mean, nsteps, halfrange);
        RealArray normalDist = realArray.getNormalDistribution(sigma);
        Assert.assertEquals("range min", 1.486e-06, normalDist.getArray()[0], 1E-06);
        Assert.assertEquals("range mid", 0.398942, normalDist.getArray()[50], 1E-06);
        Assert.assertEquals("range max", 1.486e-06, normalDist.getArray()[100], 1E-06);
        RealArray cumulativeSum = normalDist.cumulativeSum();
        Assert.assertEquals("range min", 1.5e-06, cumulativeSum.getArray()[0], 1E-06);
        Assert.assertEquals("range mid", 5.199469, cumulativeSum.getArray()[50], 1E-06);
        Assert.assertEquals("range max", 9.999996, cumulativeSum.getArray()[100], 1E-06);
...
//            System.out.println(d);
    ...
    public void testLineSearch() {
        ...
        RealArray cumulative = new RealArray(
                new double[]{0., 4., 5., 20., 23., 26., 33., 40., 41., 44., 50.});
        double d = -1.;
        double probe = 22.;
    ...
    */
    ...
    public void testGetRandomVariate() {
        ...
        RealArray freq = new RealArray(
                new double[] {
                        5., 10., 10., 1., 0., 2., 10., 15., 10., 3., 1.
                });
...
//           System.out.println(random);
    ...
    public void testSetElements() {
        ...
        try {
            ...
            Assert.assertEquals("subArray ArrayIndexOutOfBoundsException",
                    "java.lang.ArrayIndexOutOfBoundsException: was 1 in 0-4", "" + e);
        }
    }
